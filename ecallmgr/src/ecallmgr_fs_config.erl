...
%% API
-export([start_link/1, start_link/2, lookup_config/3]).
...
handle_info({fetch, directory, <<"config">>, <<"acl">>, _Value, ID, [undefined | Data]}, #state{node=Node, stats=Stats, lookups=LUs}=State) ->

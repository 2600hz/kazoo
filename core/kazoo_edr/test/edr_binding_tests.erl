...
binding_keys_test() ->
    ?assertEqual([<<"edr.warning.error.abc.app">>
                 ...
                 ,<<"edr.critical.fatal.abc.app">>], edr_bindings:binding_keys(#edr_binding{severity='warning'
                                                                                           ,verbosity='error'
                                                                                           ,account_id= <<"abc">>
                                                                                           ,app_name= <<"app">>})),
    ?assertEqual([<<"edr.critical.fatal.abc.*">>], edr_bindings:binding_keys(#edr_binding{account_id= <<"abc">>
                                                                                         ,severity='critical'
                                                                                         ,verbosity='fatal'})),
    ?assertEqual([<<"edr.warning.fatal.abc.*">>
                 ,<<"edr.warning.fatal.def.*">>
                 ,<<"edr.critical.fatal.abc.*">>
                 ,<<"edr.critical.fatal.def.*">>], edr_bindings:binding_keys(#edr_binding{account_id=[<<"abc">>, <<"def">>]
                                                                                         ,severity='warning'
                                                                                         ,verbosity='fatal'})).

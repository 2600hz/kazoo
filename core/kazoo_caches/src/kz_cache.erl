...
-spec get_props_callback(kz_proplist()) -> api(callback_fun()).
...
-spec get_props_origin(kz_proplist()) -> api(origin_tuple() | origin_tuples()).
...
-spec insert_origin_pointers(api(origin_tuple() | origin_tuples()), cache_obj(), ets:tid()) ->
                                    'ok'.

...
rename_carrier_test_() ->
    ...
    {ok, N3} = knm_number:update_phone_number(N1, [{fun knm_phone_number:update_doc/2, JObj2}]),
    ...
    {ok, N6} = knm_number:update_phone_number(N3, [{fun knm_phone_number:reset_doc/2, JObj4}]),

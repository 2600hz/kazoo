...
-spec format_block_resp_fold(kz_json:object(), knm_number:knm_numbers(), api(binary())) ->
...
%% @end
%%--------------------------------------------------------------------
-spec format_block_resp(kz_json:object(), knm_number:knm_numbers(), api(binary()), ne_binary(), ne_binary()) ->
                               knm_number:knm_numbers().
...
-spec block_resp(kz_json:object(), api(binary()), ne_binary()) ->
                        knm_number:knm_number().

...
-spec pretty_print(maybe(binary())) -> ne_binary().
...
%% @end
%%--------------------------------------------------------------------
-spec pretty_print_format(ne_binary()) -> maybe(binary()).
...
-spec pretty_print_format(ne_binary(), kz_proplist()) -> maybe(binary()).
...
-spec maybe_use_us_default(ne_binary()) -> maybe(binary()).

...
-type up_req_el() :: {ne_binary(), maybe(binary()), set_fun()}.
...
%% @end
%%--------------------------------------------------------------------
-spec assign_to_app(ne_binary(), maybe(binary())) ->
                           knm_number_return().
-spec assign_to_app(ne_binary(), maybe(binary()), knm_number_options:options()) ->
                           knm_number_return().
...
-spec maybe_update_assignment(knm_number(), maybe(binary())) -> knm_number_return().
...
%% @end
%%--------------------------------------------------------------------
-spec lookup_account(maybe(binary())) -> lookup_account_return().
...
%% @end
%%--------------------------------------------------------------------
-spec feature_prepend(knm_phone_number:knm_phone_number()) -> maybe(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec find_early_ringback(knm_phone_number:knm_phone_number()) -> maybe(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec find_transfer_ringback(knm_phone_number:knm_phone_number()) -> maybe(binary()).
...
-spec services(knm_number()) -> maybe(kz_services:services()).
...
-spec billing_id(knm_number()) -> maybe(binary()).
...
-spec num_to_did(maybe(binary()) | knm_number() | knm_phone_number:knm_phone_number()) ->
                        maybe(binary()).

...
-spec default_locality_url() -> maybe(binary()).
-spec default_locality_url(maybe(binary())) -> maybe(binary()).
...
-spec locality_url() -> maybe(binary()).
-spec locality_url(maybe(binary())) -> maybe(binary()).
locality_url() ->

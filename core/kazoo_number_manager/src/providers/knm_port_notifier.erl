...
publish_port_update(Number, Port) ->
    ...
    kapi_notify_publisher:cast(Notify, fun kapi_notifications:publish_port_request/1).
...
publish_ported(Number, Port) ->
    ...
    kapi_notify_publisher:cast(Notify, fun kapi_notifications:publish_ported/1).

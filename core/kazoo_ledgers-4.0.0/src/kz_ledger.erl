...
%% @end
%%--------------------------------------------------------------------
-spec credit(ne_binary(), integer(), ne_binary()) ->
                    {'ok', ledger()} |
                    {'error', any()}.
-spec credit(ne_binary(), integer(), ne_binary(), api_binary()) ->
                    {'ok', ledger()} |
                    {'error', any()}.
...
%% @end
%%--------------------------------------------------------------------
-spec debit(ne_binary(), integer(), ne_binary()) ->
                   {'ok', ledger()} |
                   {'error', any()}.
-spec debit(ne_binary(), integer(), ne_binary(), api_binary()) ->
                   {'ok', ledger()} |
                   {'error', any()}.
...
create(Name, Amount, Account, Desc, Type) ->
    Routines = [fun(L) -> kazoo_ledger:set_name(L, Name) end

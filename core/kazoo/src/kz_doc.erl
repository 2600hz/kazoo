...
%% @end
%%--------------------------------------------------------------------
-spec update_pvt_parameters(kz_json:object(), maybe(binary())) ->
                                   kz_json:object().
-spec update_pvt_parameters(kz_json:object(), maybe(binary()), kz_proplist()) ->
                                   kz_json:object().
...
-spec add_pvt_vsn(kz_json:object(), maybe(binary()), kz_proplist()) -> kz_json:object().
...
-spec add_pvt_account_db(kz_json:object(), maybe(binary()), kz_proplist()) -> kz_json:object().
...
-spec add_pvt_account_id(kz_json:object(), maybe(binary()), kz_proplist()) -> kz_json:object().
...
-spec add_pvt_type(kz_json:object(), maybe(binary()), kz_proplist()) -> kz_json:object().
...
-spec add_pvt_node(kz_json:object(), maybe(binary()), kz_proplist()) -> kz_json:object().
...
-spec add_pvt_created(kz_json:object(), maybe(binary()), kz_proplist()) -> kz_json:object().
...
-spec add_pvt_modified(kz_json:object(), maybe(binary()), kz_proplist()) -> kz_json:object().
add_pvt_modified(JObj, _, Opts) ->
    kz_json:set_value(?KEY_MODIFIED, props:get_value('now', Opts), JObj).

-spec modified(kz_json:object()) -> maybe(integer()).
...
-spec attachments(kz_json:object()) -> maybe(kz_json:object()).
...
-spec stub_attachments(kz_json:object()) -> maybe(kz_json:object()).
...
-spec external_attachments(kz_json:object()) -> maybe(kz_json:object()).
...
-spec attachment(kz_json:object()) -> maybe(kz_json:object()).
-spec attachment(kz_json:object(), kz_json:key()) -> maybe(kz_json:object()).
...
-spec attachment_length(kz_json:object(), ne_binary()) -> maybe(integer()).
attachment_length(JObj, AName) ->
    attachment_property(JObj, AName, <<"length">>).

-spec attachment_content_type(kz_json:object(), ne_binary()) -> maybe(binary()).
...
-spec maybe_remove_attachments(kz_json:object(), maybe(kz_json:object())) -> kz_json:object().
...
-spec maybe_remove_attachment(kz_json:object(), ne_binary(), maybe(kz_json:object())) -> kz_json:object().
...
-spec revision(kz_json:object()) -> maybe(binary()).
revision(JObj) ->
    kz_json:get_first_defined([?KEY_REV, <<"rev">>], JObj).

-spec set_revision(kz_json:object(), maybe(binary())) -> kz_json:object().
...
-spec id(kz_json:object()) -> maybe(binary()).
...
-spec type(kz_json:object()) -> maybe(binary()).
...
-spec created(kz_json:object()) -> maybe(integer()).
...
-spec account_db(kz_json:object()) -> maybe(binary()).
...
-spec vsn(kz_json:object()) -> maybe(binary()).

...
-spec add_defaults(maybe(kz_json:object()) | ne_binary(), ne_binary() | kz_json:object()) -> maybe(kz_json:object()).
...
-spec add_defaults_foldl(kz_json:key(), kz_json:object(), maybe(kz_json:object())) -> maybe(kz_json:object()).
...
-spec maybe_add_sub_properties(kz_json:key(), kz_json:object(), maybe(kz_json:object())) -> maybe(kz_json:object()).
maybe_add_sub_properties(SchemaKey, SchemaValue, JObj) ->
...
-spec maybe_add_default(kz_json:key(), kz_json:json_term(), maybe(kz_json:object())) -> maybe(kz_json:object()).

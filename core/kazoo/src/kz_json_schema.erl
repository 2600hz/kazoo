...
-spec defaults_foldl(kz_json:keys(), kz_json:object(), api_object()) -> api_object().
...
-spec maybe_sub_properties(kz_json:keys(), kz_json:object(), api_object()) -> api_object().
maybe_sub_properties(SchemaKey, SchemaValue, JObj) ->
...
-spec maybe_sub_properties_foldl(kz_json:keys(), kz_json:object(), kz_json:json_term(), {pos_integer(), kz_json:object()}) ->
...
-spec maybe_update_data_with_sub(kz_json:keys(), kz_json:object(), kz_json:object()) -> kz_json:object().
maybe_update_data_with_sub(SchemaKey, SchemaValue, JObj) ->
...
-spec maybe_default(kz_json:keys(), kz_json:json_term(), api_object()) -> api_object().
...
%% @end
%%--------------------------------------------------------------------
-spec validation_error(kz_json:keys(), ne_binary(), kz_json:object(), options()) ->
                                  validation_error().
...
-spec depreciated_validation_error(kz_json:keys(), ne_binary(), kz_json:object(), options()) ->
                                          validation_error().
...
-spec build_validate_error(kz_json:keys(), ne_binary(), kz_json:object(), options()) ->
                                  validation_error().

...
%% @end
%%--------------------------------------------------------------------
-spec advertise(maybe(terms())) -> {'ok', iolist()} |
                                {'error', string()}.
...
-spec advertise_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec publish_advertise(maybe(terms())) -> 'ok'.
-spec publish_advertise(maybe(terms()), ne_binary()) -> 'ok'.

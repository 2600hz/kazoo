...
-spec say(maybe(terms())) -> api_formatter_return() .
...
-spec say_v(maybe(terms())) -> boolean().
...
-spec tones(maybe(terms())) -> api_formatter_return() .
...
-spec tones_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec discovery_req(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec discovery_req_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec discovery_resp(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec discovery_resp_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec deaf_participant(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec deaf_participant_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec participant_energy(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec participant_energy_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec kick(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec kick_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec participants_req(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec participants_req_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec participants_resp(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec participants_resp_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec lock(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec lock_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec mute_participant(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec mute_participant_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec play(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec play_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec play_macro_req(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec play_macro_req_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec record(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec record_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec recordstop(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec recordstop_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec relate_participants(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec relate_participants_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec set(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec set_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec stop_play(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec stop_play_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec undeaf_participant(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec undeaf_participant_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec unlock(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec unlock_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec unmute_participant(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec unmute_participant_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec participant_volume_in(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec participant_volume_in_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec participant_volume_out(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec participant_volume_out_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec participants_event(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec participants_event_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec conference_error(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec conference_error_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec config_req(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec config_req_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec config_resp(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec config_resp_v(maybe(terms())) -> boolean().
...
-spec publish_search_req(maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_search_resp(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_discovery_req(maybe(terms())) -> 'ok'.
-spec publish_discovery_req(maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_discovery_resp(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_discovery_resp(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_deaf_participant(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_deaf_participant(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_participant_energy(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_participant_energy(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_kick(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_kick(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_participants_req(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_participants_req(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_participants_resp(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_participants_resp(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_lock(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_lock(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_mute_participant(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_mute_participant(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_play(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_play(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_record(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_record(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_recordstop(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_recordstop(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_relate_participants(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_relate_participants(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_set(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_set(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_stop_play(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_stop_play(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_undeaf_participant(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_undeaf_participant(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_unlock(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_unlock(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_unmute_participant(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_unmute_participant(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_participant_volume_in(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_participant_volume_in(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_participant_volume_out(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_participant_volume_out(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_participants_event(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_participants_event(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_error(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_error(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_command(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_command(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_targeted_command(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_targeted_command(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_config_req(maybe(terms())) -> 'ok'.
-spec publish_config_req(maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_config_resp(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_config_resp(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.

...
-spec say(api(terms())) -> api_formatter_return() .
...
-spec tones(api(terms())) -> api_formatter_return() .
...
-spec tones_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec search_req(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec search_req_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec search_resp(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec search_resp_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec discovery_req(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec discovery_req_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec discovery_resp(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec discovery_resp_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec deaf_participant(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec deaf_participant_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec participant_energy(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec participant_energy_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec kick(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
%% @end
%%--------------------------------------------------------------------
-spec participants_req(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec participants_req_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec participants_resp(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec participants_resp_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec lock(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
%% @end
%%--------------------------------------------------------------------
-spec mute_participant(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec mute_participant_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec play(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
%% @end
%%--------------------------------------------------------------------
-spec play_macro_req(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec play_macro_req_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec record(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec record_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec recordstop(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec recordstop_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec relate_participants(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec relate_participants_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec set(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
%% @end
%%--------------------------------------------------------------------
-spec stop_play(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec stop_play_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec undeaf_participant(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec undeaf_participant_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec unlock(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec unlock_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec unmute_participant(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec unmute_participant_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec participant_volume_in(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec participant_volume_in_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec participant_volume_out(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec participant_volume_out_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec participants_event(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec participants_event_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec conference_error(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec conference_error_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec config_req(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec config_req_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec config_resp(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec config_resp_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec publish_search_req(api(terms())) -> 'ok'.
-spec publish_search_req(api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_search_resp(ne_binary(), api(terms())) -> 'ok'.
-spec publish_search_resp(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_discovery_req(api(terms())) -> 'ok'.
-spec publish_discovery_req(api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_discovery_resp(ne_binary(), api(terms())) -> 'ok'.
-spec publish_discovery_resp(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_deaf_participant(ne_binary(), api(terms())) -> 'ok'.
-spec publish_deaf_participant(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_participant_energy(ne_binary(), api(terms())) -> 'ok'.
-spec publish_participant_energy(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_kick(ne_binary(), api(terms())) -> 'ok'.
-spec publish_kick(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_participants_req(ne_binary(), api(terms())) -> 'ok'.
-spec publish_participants_req(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_participants_resp(ne_binary(), api(terms())) -> 'ok'.
-spec publish_participants_resp(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_lock(ne_binary(), api(terms())) -> 'ok'.
-spec publish_lock(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_mute_participant(ne_binary(), api(terms())) -> 'ok'.
-spec publish_mute_participant(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_play(ne_binary(), api(terms())) -> 'ok'.
-spec publish_play(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_record(ne_binary(), api(terms())) -> 'ok'.
-spec publish_record(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_recordstop(ne_binary(), api(terms())) -> 'ok'.
-spec publish_recordstop(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_relate_participants(ne_binary(), api(terms())) -> 'ok'.
-spec publish_relate_participants(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_set(ne_binary(), api(terms())) -> 'ok'.
-spec publish_set(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_stop_play(ne_binary(), api(terms())) -> 'ok'.
-spec publish_stop_play(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_undeaf_participant(ne_binary(), api(terms())) -> 'ok'.
-spec publish_undeaf_participant(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_unlock(ne_binary(), api(terms())) -> 'ok'.
-spec publish_unlock(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_unmute_participant(ne_binary(), api(terms())) -> 'ok'.
-spec publish_unmute_participant(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_participant_volume_in(ne_binary(), api(terms())) -> 'ok'.
-spec publish_participant_volume_in(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_participant_volume_out(ne_binary(), api(terms())) -> 'ok'.
-spec publish_participant_volume_out(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_participants_event(ne_binary(), api(terms())) -> 'ok'.
-spec publish_participants_event(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_command(ne_binary(), api(terms())) -> 'ok'.
-spec publish_command(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_targeted_command(ne_binary(), api(terms())) -> 'ok'.
-spec publish_targeted_command(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_config_req(api(terms())) -> 'ok'.
-spec publish_config_req(api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec publish_config_resp(ne_binary(), api(terms())) -> 'ok'.
-spec publish_config_resp(ne_binary(), api(terms()), ne_binary()) -> 'ok'.

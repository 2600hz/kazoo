...
%% @end
%%--------------------------------------------------------------------
-spec authz_req(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec authz_req_v(maybe(terms())) -> boolean().
...
-spec balance_check_req(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec balance_check_req_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec authz_resp(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec authz_resp_v(maybe(terms())) -> boolean().
...
-spec balance_check_resp(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec balance_check_resp_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec publish_authz_req(maybe(terms())) -> 'ok'.
-spec publish_authz_req(maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_authz_resp(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_authz_resp(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_balance_check_req(maybe(terms())) -> 'ok'.
-spec publish_balance_check_req(maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_balance_check_resp(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_balance_check_resp(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
-spec broadcast_authz_resp(maybe(terms())) -> 'ok'.
-spec broadcast_authz_resp(maybe(terms()), ne_binary()) -> 'ok'.

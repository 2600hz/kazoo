...
-spec reload_acls(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec reload_acls_v(api(terms())) -> boolean().
...
-spec reload_gateways(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec reload_gateways_v(api(terms())) -> boolean().
...
-spec fs_xml_flush(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec fs_xml_flush_v(api(terms())) -> boolean().
...
-spec check_sync(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec check_sync_v(api(terms())) -> boolean().
...
-spec fs_command(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec fs_command_v(api(terms())) -> boolean().
...
%% Reply to fs command
-spec fs_reply(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec fs_reply_v(api(terms())) -> boolean().
...
-spec publish_fs_xml_flush(api(terms())) -> 'ok'.
-spec publish_fs_xml_flush(api(terms()), binary()) -> 'ok'.
...
-spec publish_check_sync(api(terms())) -> 'ok'.
-spec publish_check_sync(api(terms()), binary()) -> 'ok'.
...
-spec check_sync_realm(api(terms())) -> api(binary()).
...
-spec check_sync_username(api(terms())) -> api(binary()).
...
-spec check_sync_value(api(terms()), ne_binary(), fun()) -> api(binary()).
check_sync_value(API, Key, Get) ->
    Get(Key, API).

-spec publish_command(api(terms())) -> 'ok'.
-spec publish_command(api(terms()), binary()) -> 'ok'.
...
-spec publish_reply(binary(), api(terms())) -> 'ok'.
...
-spec check_fs_node(api(terms())) -> api(binary()).
check_fs_node(Props) when is_list(Props) ->
    get_value(Props, <<"FreeSWITCH-Node">>, <<"*">>).

-spec get_value(api(terms()), ne_binary(), ne_binary()) -> api(binary()).
...
-spec get_value(api(terms()), ne_binary(), fun(), ne_binary()) -> api(binary()).

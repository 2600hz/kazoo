...
%% @end
%%--------------------------------------------------------------------
-spec resp(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
%% @end
%%--------------------------------------------------------------------
-spec error(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec publish_resp(ne_binary(), maybe(terms()), binary()) -> 'ok'.
...
-spec publish_error(ne_binary(), maybe(terms()), binary()) -> 'ok'.
...
%% @end
%%-----------------------------------------------------------------------------
-spec get_authn_req_routing(ne_binary() | maybe(terms())) -> ne_binary().
...
%% @end
%%-----------------------------------------------------------------------------
-spec get_auth_user(kz_json:object()) -> maybe(binary()).
...
%% @end
%%-----------------------------------------------------------------------------
-spec get_auth_realm(kz_json:object() | kz_proplist()) -> ne_binary().

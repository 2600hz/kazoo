...
-spec originate_req(maybe(terms())) -> api_formatter_return().
...
-spec originate_req_v(maybe(terms())) -> boolean().
...
-spec originate_req_endpoint_headers(maybe(terms())) ->
                                     {'ok', kz_proplist()} |
                                     {'error', string()}.
...
-spec originate_req_endpoint_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec originate_resp(maybe(terms())) ->
                            {'ok', iolist()} |
                            {'error', string()}.
...
-spec originate_resp_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec originate_started(maybe(terms())) ->
                               {'ok', iolist()} |
                               {'error', string()}.
...
-spec originate_started_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec originate_uuid(maybe(terms())) ->
                            {'ok', iolist()} |
                            {'error', string()}.
...
-spec originate_uuid_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec eavesdrop_req(maybe(terms())) ->
                           {'ok', iolist()} |
                           {'error', string()}.
...
-spec eavesdrop_req_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec eavesdrop_resp(maybe(terms())) ->
                            {'ok', iolist()} |
                            {'error', string()}.
...
-spec eavesdrop_resp_v(maybe(terms())) -> boolean().
...
-spec publish_originate_req(maybe(terms())) -> 'ok'.
-spec publish_originate_req(maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_originate_resp(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_originate_resp(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_originate_started(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_originate_started(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_originate_uuid(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_originate_uuid(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_eavesdrop_req(maybe(terms())) -> 'ok'.
-spec publish_eavesdrop_req(maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_eavesdrop_resp(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_eavesdrop_resp(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.

...
-spec publish_search_req(api(terms()), binary()) -> 'ok'.
...
-spec search_req_routing_key(ne_binary() | api(terms())) -> ne_binary().
...
-spec publish_search_resp(ne_binary(), api(terms()), binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec subscribe(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec subscribe_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec update(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec update_v(api(terms())) -> boolean().
...
-spec update_routing_key(ne_binary() | api(terms())) -> ne_binary().
...
%% @end
%%--------------------------------------------------------------------
-spec probe(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec probe_v(api(terms())) -> boolean().
...
-spec publish_probe(api(terms())) -> 'ok'.
-spec publish_probe(api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec mwi_update(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec mwi_update_v(api(terms())) -> boolean().
...
-spec publish_mwi_update(api(terms())) -> 'ok'.
-spec publish_mwi_update(api(terms()), ne_binary()) -> 'ok'.
...
-spec mwi_update_routing_key(api(terms()) | api(binary())) -> ne_binary().
...
%% @end
%%--------------------------------------------------------------------
-spec mwi_query(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec mwi_query_v(api(terms())) -> boolean().
...
-spec publish_mwi_query(api(terms())) -> 'ok'.
-spec publish_mwi_query(api(terms()), ne_binary()) -> 'ok'.
...
-spec register_overwrite_v(api(terms())) -> boolean().
...
-spec publish_register_overwrite(api(terms())) -> 'ok'.
-spec publish_register_overwrite(api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec reset(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec reset_v(api(terms())) -> boolean().
...
-spec publish_reset(api(terms())) -> 'ok'.
-spec publish_reset(api(terms()), binary()) -> 'ok'.
publish_reset(JObj) ->
...
-spec reset_routing_key(ne_binary() | api(terms())) -> ne_binary().
...
%% @end
%%--------------------------------------------------------------------
-spec flush(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
%% @end
%%--------------------------------------------------------------------
-spec sync(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
%% @end
%%--------------------------------------------------------------------
-spec is_valid_state(api(binary()) | api(terms())) -> boolean().

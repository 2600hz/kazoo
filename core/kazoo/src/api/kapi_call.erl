...
%% @end
%%--------------------------------------------------------------------
-spec event(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec event_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec channel_status_req(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec channel_status_req_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec channel_status_resp(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec channel_status_resp_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec query_auth_id_req(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec query_auth_id_req_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec query_auth_id_resp(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec query_auth_id_resp_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec query_user_channels_req(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec query_user_channels_req_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec query_user_channels_resp(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec query_user_channels_resp_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec query_account_channels_req(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec query_account_channels_req_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec query_account_channels_resp(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec query_account_channels_resp_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec query_channels_req(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec query_channels_req_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec query_channels_resp(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec query_channels_resp_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec usurp_control(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec usurp_control_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec usurp_publisher(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec usurp_publisher_v(api(terms())) -> boolean().
...
-spec publish_event(api(terms())) -> 'ok'.
-spec publish_event(api(terms()), ne_binary()) -> 'ok'.
...
-spec publish_channel_status_req(api(terms())) -> 'ok'.
-spec publish_channel_status_req(ne_binary(), api(terms())) -> 'ok'.
-spec publish_channel_status_req(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
-spec publish_channel_status_resp(ne_binary(), api(terms())) -> 'ok'.
-spec publish_channel_status_resp(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
-spec publish_query_auth_id_req(api(terms())) -> 'ok'.
-spec publish_query_auth_id_req(ne_binary(), api(terms())) -> 'ok'.
-spec publish_query_auth_id_req(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
-spec publish_query_auth_id_resp(ne_binary(), api(terms())) -> 'ok'.
-spec publish_query_auth_id_resp(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
-spec publish_query_user_channels_resp(ne_binary(), api(terms())) -> 'ok'.
-spec publish_query_user_channels_resp(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
-spec publish_query_account_channels_req(api(terms())) -> 'ok'.
-spec publish_query_account_channels_req(api(terms()), ne_binary(), ne_binary()) -> 'ok'.
...
-spec publish_query_account_channels_resp(ne_binary(), api(terms())) -> 'ok'.
-spec publish_query_account_channels_resp(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
-spec publish_query_channels_req(api(terms())) -> 'ok'.
-spec publish_query_channels_req(api(terms()), ne_binary()) -> 'ok'.
...
-spec publish_query_channels_resp(ne_binary(), api(terms())) -> 'ok'.
-spec publish_query_channels_resp(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
-spec publish_usurp_control(ne_binary(), api(terms())) -> 'ok'.
-spec publish_usurp_control(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
-spec publish_usurp_publisher(ne_binary(), api(terms())) -> 'ok'.
-spec publish_usurp_publisher(ne_binary(), api(terms()), ne_binary()) -> 'ok'.

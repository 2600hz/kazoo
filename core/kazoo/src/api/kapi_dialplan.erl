...
%% @end
%%--------------------------------------------------------------------
-spec bridge(maybe(terms())) -> api_formatter_return().
...
-spec bridge_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec unbridge(maybe(terms())) -> api_formatter_return().
...
-spec unbridge_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec bridge_endpoint(maybe(terms())) ->
                             {'ok', kz_proplist()} |
                             {'error', string()}.
...
-spec bridge_endpoint_headers(maybe(terms())) ->
                                     {'ok', kz_proplist()} |
                                     {'error', string()}.
...
-spec bridge_endpoint_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec page(maybe(terms())) -> api_formatter_return().
...
-spec page_v(maybe(terms())) -> boolean().
...
-spec store_v(maybe(terms())) -> boolean().
...
-spec store_amqp_resp(maybe(terms())) -> api_formatter_return().
...
-spec store_amqp_resp_v(maybe(terms())) -> boolean().
...
-spec store_http_resp(maybe(terms())) -> api_formatter_return().
...
-spec store_http_resp_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec send_dtmf(maybe(terms())) -> api_formatter_return() .
...
-spec send_dtmf_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec tones_req_tone(maybe(terms())) -> api_formatter_return().
...
-spec tones_req_tone_v(maybe(terms())) -> boolean().
...
-spec tones_req_tone_headers(maybe(terms())) ->
                                    {'ok', kz_proplist()} |
                                    {'error', string()}.
...
%% @end
%%--------------------------------------------------------------------
-spec tone_detect(maybe(terms())) -> api_formatter_return().
...
-spec tone_detect_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec queue(maybe(terms())) -> api_formatter_return().
...
-spec queue_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec play(maybe(terms())) -> api_formatter_return().
...
%% @end
%%--------------------------------------------------------------------
-spec break(maybe(terms())) -> api_formatter_return().
...
-spec break_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec playstop(maybe(terms())) -> api_formatter_return().
...
-spec playstop_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec tts(maybe(terms())) -> api_formatter_return().
...
-spec tts_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec record(maybe(terms())) -> api_formatter_return().
...
%% @end
%%--------------------------------------------------------------------
-spec record_call(maybe(terms())) -> api_formatter_return().
...
-spec record_call_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec answer(maybe(terms())) -> api_formatter_return().
...
-spec answer_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec echo(maybe(terms())) -> api_formatter_return().
...
-spec echo_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec privacy(maybe(terms())) -> api_formatter_return().
...
-spec privacy_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec progress(maybe(terms())) -> api_formatter_return().
...
-spec progress_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec ring(maybe(terms())) -> api_formatter_return().
...
-spec ring_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec receive_fax(maybe(terms())) -> api_formatter_return().
...
-spec receive_fax_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec store_fax(maybe(terms())) -> api_formatter_return().
...
-spec store_fax_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec hangup(maybe(terms())) -> api_formatter_return().
...
-spec hangup_v(maybe(terms())) -> boolean().
...
-spec soft_hold(maybe(terms())) -> api_formatter_return().
...
-spec soft_hold_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec hold(maybe(terms())) -> api_formatter_return().
...
-spec hold_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec park(maybe(terms())) -> api_formatter_return().
...
-spec park_v(maybe(terms())) -> boolean().
...
-spec audio_level(maybe(terms())) -> api_formatter_return().
...
-spec audio_level_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec set(maybe(terms())) -> api_formatter_return().
...
%% @end
%%--------------------------------------------------------------------
-spec set_terminators(maybe(terms())) -> api_formatter_return().
...
-spec set_terminators_v(maybe(terms())) -> boolean() .
...
%% @end
%%--------------------------------------------------------------------
-spec fetch(maybe(terms())) -> api_formatter_return().
...
-spec fetch_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec play_and_collect_digits(maybe(terms())) -> api_formatter_return().
...
-spec play_and_collect_digits_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec call_pickup(maybe(terms())) -> api_formatter_return().
...
-spec call_pickup_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec connect_leg(maybe(terms())) -> api_formatter_return().
...
-spec connect_leg_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec eavesdrop(maybe(terms())) -> api_formatter_return().
...
-spec eavesdrop_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec respond(maybe(terms())) -> api_formatter_return().
...
-spec respond_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec redirect(maybe(terms())) -> api_formatter_return().
...
-spec redirect_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec execute_extension(maybe(terms())) -> api_formatter_return().
...
-spec execute_extension_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec sleep(maybe(terms())) -> api_formatter_return().
...
-spec sleep_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec noop(maybe(terms())) -> api_formatter_return().
...
-spec noop_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec conference(maybe(terms())) -> api_formatter_return().
...
-spec conference_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec originate_ready(maybe(terms())) -> api_formatter_return().
...
-spec originate_ready_v(maybe(terms())) -> boolean().
...
-spec originate_execute(maybe(terms())) -> api_formatter_return().
...
-spec originate_execute_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec error(maybe(terms())) -> api_formatter_return().
...
-spec error_v(maybe(terms())) -> boolean().
...
-spec publish_metaflow(maybe(terms())) -> 'ok'.
-spec publish_metaflow(maybe(terms()), ne_binary()) -> 'ok'.
...
-spec metaflow_callid(maybe(terms())) -> maybe(binary()).
...
-spec publish_originate_ready(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_originate_ready(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_originate_execute(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_originate_execute(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec metaflow(maybe(terms())) -> api_formatter_return().
...
-spec metaflow_v(maybe(terms())) -> boolean().
...
-spec bind_q(ne_binary(), kz_proplist(), maybe('true')) -> 'ok'.
...
-spec unbind_q(ne_binary(), kz_proplist(), maybe('true')) -> 'ok'.
...
-spec offsite_store_url(maybe(binary()), ne_binary()) -> ne_binary().
...
%% @end
%%--------------------------------------------------------------------
-spec fax_detection(maybe(terms())) -> api_formatter_return().
...
-spec fax_detection_v(maybe(terms())) -> boolean().
...
-spec store_vm_v(maybe(terms())) -> boolean().

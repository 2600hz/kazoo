...
%% @end
%%--------------------------------------------------------------------
-spec bridge(api(terms())) -> api_formatter_return().
...
-spec bridge_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec unbridge(api(terms())) -> api_formatter_return().
...
-spec unbridge_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec bridge_endpoint(api(terms())) ->
                             {'ok', kz_proplist()} |
                             {'error', string()}.
...
-spec bridge_endpoint_headers(api(terms())) ->
                                     {'ok', kz_proplist()} |
                                     {'error', string()}.
...
-spec bridge_endpoint_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec page(api(terms())) -> api_formatter_return().
...
-spec store_v(api(terms())) -> boolean().
...
-spec store_amqp_resp(api(terms())) -> api_formatter_return().
...
-spec store_amqp_resp_v(api(terms())) -> boolean().
...
-spec store_http_resp(api(terms())) -> api_formatter_return().
...
-spec store_http_resp_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec send_dtmf(api(terms())) -> api_formatter_return() .
...
-spec send_dtmf_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec tones_req_tone(api(terms())) -> api_formatter_return().
...
-spec tones_req_tone_v(api(terms())) -> boolean().
...
-spec tones_req_tone_headers(api(terms())) ->
                                    {'ok', kz_proplist()} |
                                    {'error', string()}.
...
%% @end
%%--------------------------------------------------------------------
-spec tone_detect(api(terms())) -> api_formatter_return().
...
-spec tone_detect_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec queue(api(terms())) -> api_formatter_return().
...
-spec queue_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec play(api(terms())) -> api_formatter_return().
...
%% @end
%%--------------------------------------------------------------------
-spec break(api(terms())) -> api_formatter_return().
...
-spec break_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec playstop(api(terms())) -> api_formatter_return().
...
-spec playstop_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec tts(api(terms())) -> api_formatter_return().
...
%% @end
%%--------------------------------------------------------------------
-spec record(api(terms())) -> api_formatter_return().
...
%% @end
%%--------------------------------------------------------------------
-spec record_call(api(terms())) -> api_formatter_return().
...
-spec record_call_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec answer(api(terms())) -> api_formatter_return().
...
-spec answer_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec echo(api(terms())) -> api_formatter_return().
...
%% @end
%%--------------------------------------------------------------------
-spec privacy(api(terms())) -> api_formatter_return().
...
-spec privacy_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec progress(api(terms())) -> api_formatter_return().
...
-spec progress_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec ring(api(terms())) -> api_formatter_return().
...
%% @end
%%--------------------------------------------------------------------
-spec receive_fax(api(terms())) -> api_formatter_return().
...
-spec receive_fax_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec store_fax(api(terms())) -> api_formatter_return().
...
-spec store_fax_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec hangup(api(terms())) -> api_formatter_return().
...
-spec hangup_v(api(terms())) -> boolean().
...
-spec soft_hold(api(terms())) -> api_formatter_return().
...
-spec soft_hold_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec hold(api(terms())) -> api_formatter_return().
...
%% @end
%%--------------------------------------------------------------------
-spec park(api(terms())) -> api_formatter_return().
...
-spec audio_level(api(terms())) -> api_formatter_return().
...
-spec audio_level_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec set(api(terms())) -> api_formatter_return().
...
%% @end
%%--------------------------------------------------------------------
-spec set_terminators(api(terms())) -> api_formatter_return().
...
-spec set_terminators_v(api(terms())) -> boolean() .
...
%% @end
%%--------------------------------------------------------------------
-spec fetch(api(terms())) -> api_formatter_return().
...
-spec fetch_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec play_and_collect_digits(api(terms())) -> api_formatter_return().
...
-spec play_and_collect_digits_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec call_pickup(api(terms())) -> api_formatter_return().
...
-spec call_pickup_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec connect_leg(api(terms())) -> api_formatter_return().
...
-spec connect_leg_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec eavesdrop(api(terms())) -> api_formatter_return().
...
-spec eavesdrop_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec respond(api(terms())) -> api_formatter_return().
...
-spec respond_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec redirect(api(terms())) -> api_formatter_return().
...
-spec redirect_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec execute_extension(api(terms())) -> api_formatter_return().
...
-spec execute_extension_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec sleep(api(terms())) -> api_formatter_return().
...
-spec sleep_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec noop(api(terms())) -> api_formatter_return().
...
%% @end
%%--------------------------------------------------------------------
-spec conference(api(terms())) -> api_formatter_return().
...
-spec conference_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec originate_ready(api(terms())) -> api_formatter_return().
...
-spec originate_ready_v(api(terms())) -> boolean().
...
-spec originate_execute(api(terms())) -> api_formatter_return().
...
-spec originate_execute_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec error(api(terms())) -> api_formatter_return().
...
-spec publish_metaflow(api(terms())) -> 'ok'.
-spec publish_metaflow(api(terms()), ne_binary()) -> 'ok'.
...
-spec metaflow_callid(api(terms())) -> api(binary()).
...
-spec publish_originate_ready(ne_binary(), api(terms())) -> 'ok'.
-spec publish_originate_ready(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
-spec publish_originate_execute(ne_binary(), api(terms())) -> 'ok'.
-spec publish_originate_execute(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec metaflow(api(terms())) -> api_formatter_return().
...
-spec metaflow_v(api(terms())) -> boolean().
...
-spec bind_q(ne_binary(), kz_proplist(), api('true')) -> 'ok'.
...
-spec unbind_q(ne_binary(), kz_proplist(), api('true')) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec fax_detection(api(terms())) -> api_formatter_return().
...
-spec fax_detection_v(api(terms())) -> boolean().
...
-spec store_vm_v(api(terms())) -> boolean().

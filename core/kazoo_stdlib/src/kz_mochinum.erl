...
int_ceil_test_() ->
    [?_assertEqual(1, int_ceil(0.0001))
    ,?_assertEqual(0, int_ceil(0.0))
    ,?_assertEqual(1, int_ceil(0.99))
    ,?_assertEqual(1, int_ceil(1.0))
    ,?_assertEqual(-1, int_ceil(-1.5))
    ,?_assertEqual(-2, int_ceil(-2.0))
    ].

int_pow_test_() ->
    [?_assertEqual(1, int_pow(1, 1))
    ,?_assertEqual(1, int_pow(1, 0))
    ,?_assertEqual(1, int_pow(10, 0))
    ,?_assertEqual(10, int_pow(10, 1))
    ,?_assertEqual(100, int_pow(10, 2))
    ,?_assertEqual(1000, int_pow(10, 3))
    ].
...
digits_test_() ->
    ...
    ,?_assertEqual("0.5",
                   digits(0.5))
    ,?_assertEqual("4503599627370496.0",
                   digits(4503599627370496.0))
    ,?_assertEqual("5.0e-324",
                   digits(SmallDenorm))
    ,?_assertEqual(SmallDenorm,
                   list_to_float(digits(SmallDenorm)))
    ,?_assertEqual("2.225073858507201e-308",
                   digits(BigDenorm))
    ,?_assertEqual(BigDenorm,
                   list_to_float(digits(BigDenorm)))
    ,?_assertEqual("2.2250738585072014e-308",
                   digits(SmallNorm))
    ,?_assertEqual(SmallNorm,
                   list_to_float(digits(SmallNorm)))
    ,?_assertEqual("1.7976931348623157e+308",
                   digits(LargeNorm))

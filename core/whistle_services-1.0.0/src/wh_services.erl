...
%% @end
%%--------------------------------------------------------------------
-spec calculate_services_charges(services()) -> {'no_plan' | 'error' | 'ok', wh_json:object()}.
-spec calculate_services_charges(services(), wh_service_plans:plans()) -> {'error' | 'ok', wh_json:object()}.
...
%% @end
%%--------------------------------------------------------------------
-spec calculate_transactions_charges(wh_json:object(), wh_transaction:transactions()) -> wh_json:object().
calculate_transactions_charges(PlansCharges, Transactions) ->
    lists:foldl(

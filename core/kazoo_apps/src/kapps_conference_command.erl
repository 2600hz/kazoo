...
-spec kick(maybe(non_neg_integer()), kapps_conference:conference()) -> 'ok'.
...
-spec prompt(ne_binary(), maybe(non_neg_integer()), kapps_conference:conference()) -> 'ok'.
...
-spec play_command(ne_binary(), maybe(non_neg_integer())) -> kz_proplist().
...
-spec play(ne_binary(), maybe(non_neg_integer()), kapps_conference:conference()) -> 'ok'.
...
-spec relate_participants(non_neg_integer(), non_neg_integer(), maybe(binary()), kapps_conference:conference()) -> 'ok'.
...
-spec stop_play(maybe(non_neg_integer()), kapps_conference:conference()) -> 'ok'.
-spec stop_play(maybe(non_neg_integer()), maybe(binary()), kapps_conference:conference()) -> 'ok'.
...
-spec send_command(maybe(terms()), kapps_conference:conference()) -> 'ok'.

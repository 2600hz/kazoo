...
-spec copy_object(string(), string(), string(), string(), proplists:proplist() | aws_config()) ->
          {'ok', proplists:proplist()} | {'error', any()} .
...
-spec create_bucket(string()) -> {'ok', proplists:proplist()} | {'error', any()} .
...
-spec delete_bucket(string()) -> {'ok', proplists:proplist()} | {'error', any()} .

delete_bucket(BucketName) ->
    delete_bucket(BucketName, default_config()).

-spec delete_bucket(string(), aws_config()) -> {'ok', proplists:proplist()} | {'error', any()} .
...
-spec delete_object(string(), string()) -> {'ok', proplists:proplist()} | {'error', any()} .
...
-spec list_objects(string()) -> proplists:proplist().
...
-spec get_object(string(), string()) -> {'ok', proplists:proplist()} | {'error', any()} .

get_object(BucketName, Key) ->
    get_object(BucketName, Key, []).

-spec get_object(string(), string(), proplists:proplist() | aws_config()) ->
          {'ok', proplists:proplist()} | {'error', any()} .
...
-spec get_object_metadata(string(), string(), proplists:proplist() | aws_config()) ->
          {'ok', proplists:proplist()} | {'error', any()} .
...
-spec get_object_metadata(string(), string(), proplists:proplist(), proplists:proplist() | aws_config()) ->
          {'ok', proplists:proplist()} | {'error', any()} .
...
-spec list_object_versions(string()) -> proplists:proplist().
...
-spec put_object(string(), string(), iodata(), proplists:proplist() | aws_config()) ->
          {'ok', proplists:proplist()} | {'error', any()} .
...
-spec put_object(string(), string(), iodata(), proplists:proplist(), [{string(), string()}] | aws_config()) ->
          {'ok', proplists:proplist()} | {'error', any()} .
...
-spec set_object_acl(string(), string(), proplists:proplist()) ->
          {'ok', proplists:proplist()} | {'error', any()} .

set_object_acl(BucketName, Key, ACL) ->
    set_object_acl(BucketName, Key, ACL, default_config()).

-spec set_object_acl(string(), string(), proplists:proplist(), aws_config()) ->
          {'ok', proplists:proplist()} | {'error', any()} .
...
-spec start_multipart(string(), string()) -> {ok, proplists:proplist()} | {error, any()}.
start_multipart(BucketName, Key)
  when is_list(BucketName), is_list(Key) ->
    start_multipart(BucketName, Key, [], [], default_config()).

-spec start_multipart(string(), string(), proplists:proplist(), [{string(), string()}], aws_config()) -> {ok, proplists:proplist()} | {error, any()}.
...
-spec upload_part(string(), string(), string(), integer(), iodata()) -> {ok, proplists:proplist()} | {error, any()}.
upload_part(BucketName, Key, UploadId, PartNumber, Value) ->
    upload_part(BucketName, Key, UploadId, PartNumber, Value, [], default_config()).

-spec upload_part(string(), string(), string(), integer(), iodata(), [{string(), string()}], aws_config()) -> {ok, proplists:proplist()} | {error, any()}.
upload_part(BucketName, Key, UploadId, PartNumber, Value, HTTPHeaders, Config)
  when is_list(BucketName), is_list(Key), is_list(UploadId), is_integer(PartNumber),
    ...
    POSTData = iolist_to_binary(Value),
    case s3_request(Config, put, BucketName, [$/|Key], [], [{"uploadId", UploadId},
...
-spec complete_multipart(string(), string(), string(), [{integer(), string()}]) -> {ok, proplists:proplist()} | {error, any()}.
...
complete_multipart(BucketName, Key, UploadId, ETags, HTTPHeaders, Config)
  when is_list(BucketName), is_list(Key), is_list(UploadId), is_list(ETags), is_list(HTTPHeaders), is_record(Config, aws_config) ->
    ...
    case s3_request(Config, post, BucketName, [$/|Key], [], [{"uploadId", UploadId}],
                     POSTData, HTTPHeaders) of
        {ok, {_Headers, _Body}} ->
            ok;
        Error ->
...
-spec abort_multipart(string(), string(), string(), proplists:proplist(), [{string(), string()}], aws_config()) -> ok | {error, any()}.
...
-spec list_multipart_uploads(string()) -> {ok, proplists:proplist()} | {error, any()}.
list_multipart_uploads(BucketName)
  when is_list(BucketName) ->

    list_multipart_uploads(BucketName, [], [], default_config()).

-spec list_multipart_uploads(string(), proplists:proplist()) -> {ok, proplists:proplist()} | {error, any()}.
list_multipart_uploads(BucketName, Options)
  when is_list(BucketName), is_list(Options) ->

    list_multipart_uploads(BucketName, Options, [], default_config()).

-spec list_multipart_uploads(string(), proplists:proplist(), [{string(), string()}], aws_config()) -> {ok, proplists:proplist()} | {error, any()}.

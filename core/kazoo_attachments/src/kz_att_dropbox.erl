...
-define(DRV_DROPBOX_HEADER(I), {"Dropbox-API-Arg", kz_term:to_list(kz_json:encode(kz_json:from_list([{<<"path">>, I}])))}).
...
-spec dropbox_post(kz_term:ne_binary(), kz_term:proplist(), iodata()) ->

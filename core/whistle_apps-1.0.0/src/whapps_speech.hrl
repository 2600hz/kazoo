...
-define(ISPEECH_TTS_URL, whapps_config:get_string(?MOD_CONFIG_CAT, <<"tts_url">>, <<"http://api.ispeech.org/api/json">>)).
...
-define(VOICEFABRIC_TTS_URL, whapps_config:get_string(?MOD_CONFIG_CAT, <<"tts_url">>, <<"https://voicefabric.ru/WSServer/ws/tts">>)).

-define(TMP_PATH, whapps_config:get(?MOD_CONFIG_CAT, <<"temporary_storage_path">>, <<"/tmp">>)).

-define(WHAPPS_SPEECH_HRL, 'true').
-endif.

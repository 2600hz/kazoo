...
create(<<"voicefabric">> = Engine, Text, Voice, <<"wav">> = _Format, Options) ->
    ...
    VoiceMappings = [ %% Владимир8000
                     ...
                     %% Анна8000
                     ,{<<"female/ru-ru">>, <<208,144,208,189,208,189,208,176,56,48,48,48>>}
                     %% Виктория8000
                     ,{<<"female/ru-ru">>, <<208,146,208,184,208,186,209,130,208,190,209,128,208,184,209,143,56,48,48,48>>}
                     %% Александр8000
                     ,{<<"male/ru-ru">>, <<208,144,208,187,208,181,208,186,209,129,208,176,208,189,208,180,209,128,56,48,48,48>>}
                     %% Мария8000
                     ,{<<"female/ru-ru">>, <<208,156,208,176,209,128,208,184,209,143,56,48,48,48>>}
                     %% Лидия8000
                     ,{<<"female/ru-ru">>, <<208,155,208,184,208,180,208,184,209,143,56,48,48,48>>}
                    ],
    case props:get_value(wh_util:to_lower_binary(Voice), VoiceMappings) of
        'undefined' ->
            {'error', 'invalid_voice'};

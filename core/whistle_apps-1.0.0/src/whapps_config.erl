...
-spec fetch_value(config_category(), config_key(), config_key(), Default, wh_json:object()) ->
                         Default | term().
fetch_value(Category, Node, Keys, Default, JObj) ->
...
-spec fetch_default_value(config_category(), config_key(), Default, wh_json:object()) ->
                                 Default | term().
...
%% @end
%%-----------------------------------------------------------------------------
-spec import(config_category()) -> {'ok', wh_json:object()}.
...
%% @end
%%-----------------------------------------------------------------------------
-spec fetch_category(ne_binary(), atom()) -> fetch_ret().
...
%% @end
%%-----------------------------------------------------------------------------
-spec fetch_db_config(ne_binary(), atom()) -> fetch_ret().
...
%% @end
%%-----------------------------------------------------------------------------
-spec fetch_file_config(ne_binary(), atom()) -> {'ok', wh_json:object()}.
...
%% @end
%%-----------------------------------------------------------------------------
-spec config_terms_to_json(wh_proplist()) -> wh_json:object().
...
%% @end
%%-----------------------------------------------------------------------------
-spec do_set(config_category(), config_key(), term(), ne_binary() | atom()) ->
                    {'ok', wh_json:object()}.
...
-spec update_category_node(ne_binary(), ne_binary(), update_fun(), atom()) ->
                                  {'ok', wh_json:object()}.
...
%% @end
%%-----------------------------------------------------------------------------
-spec update_category(ne_binary(), wh_json:object(), atom()) ->
                             {'ok', wh_json:object()}.
-spec update_category(ne_binary(), wh_json:object(), atom(), boolean()) ->
                             {'ok', wh_json:object()}.
...
-spec cache_jobj(atom(), ne_binary(), wh_json:object()) ->
                        {'ok', wh_json:object()}.

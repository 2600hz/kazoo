...
move_phone_number_to_reserved_state(PhoneNumber, AssignTo, AssignTo) ->
    knm_phone_number:set_state(PhoneNumber, ?NUMBER_STATE_RESERVED);
move_phone_number_to_reserved_state(PhoneNumber, AssignedTo, AssignTo) ->

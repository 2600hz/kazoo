...
do_promote(AccountId) ->
    _ = kz_account:do_update(AccountId, fun kz_account:promote/1),
...
do_demote(AccountId) ->
    _ = kz_account:do_update(AccountId, fun kz_account:demote/1),
...
cascade_reseller_id(Reseller, Account) ->
    AccountId = kz_account:format_id(Account, 'raw'),
    ResellerId = kz_account:format_id(Reseller, 'raw'),
...
set_reseller_id(Reseller, Account) ->
    ...
    _ = kz_account:do_update(AccountId, fun(JObj) -> kz_account:set_reseller_id(JObj, ResellerId) end),

...
-spec fetch_plan(kz_term:ne_binary(), kz_term:ne_binary(), kz_json:object()) -> kz_term:api_object().
...
public_json([], JObj) ->
    kz_doc:public_fields(kzd_service_plan:set_plan(kzd_service_plan:new(), JObj));

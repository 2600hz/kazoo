...
-define(KEY_TRANSCRIBE_FILENAME, <<"transcribe_filename">>).
...
new(AccountId, Props) ->
    ...
    DocProps = [{<<"_id">>, MsgId}
               ...
               ,{?KEY_MEDIA_FILENAME, gen_attachment_filename(Props)}
               ,{?KEY_TRANSCRIBE_FILENAME, gen_transcribe_filename(Props)}
               ,{?KEY_STREAMABLE, 'true'}

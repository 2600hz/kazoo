...
new(AccountId, Props) ->
    UtcSeconds = props:get_integer_value(<<"Message-Timestamp">>, Props, kz_util:current_tstamp()),
...
create_message_name(BoxNum, Timezone, UtcSeconds) ->
    UtcDateTime = calendar:gregorian_seconds_to_datetime(kz_util:to_integer(UtcSeconds)),

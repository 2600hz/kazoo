...
-export([push_token_app/1, push_token_app/2, set_push_token_app/2]).
-export([push_token_id/1, push_token_id/2, set_push_token_id/2]).
-export([push_token_proxy/1, push_token_proxy/2, set_push_token_proxy/2]).
-export([push_token_type/1, push_token_type/2, set_push_token_type/2]).
...
-spec push(doc()) -> kz_term:api_object().
push(Doc) ->
    push(Doc, 'undefined').
...
-spec push_token_app(doc()) -> kz_term:api_binary().
push_token_app(Doc) ->
    push_token_app(Doc, 'undefined').

-spec push_token_app(doc(), Default) -> binary() | Default.
push_token_app(Doc, Default) ->
    kz_json:get_binary_value([<<"push">>, <<"Token-App">>], Doc, Default).

-spec set_push_token_app(doc(), binary()) -> doc().
set_push_token_app(Doc, PushTokenApp) ->
    kz_json:set_value([<<"push">>, <<"Token-App">>], PushTokenApp, Doc).

-spec push_token_id(doc()) -> kz_term:api_binary().
push_token_id(Doc) ->
    push_token_id(Doc, 'undefined').

-spec push_token_id(doc(), Default) -> binary() | Default.
push_token_id(Doc, Default) ->
    kz_json:get_binary_value([<<"push">>, <<"Token-ID">>], Doc, Default).

-spec set_push_token_id(doc(), binary()) -> doc().
set_push_token_id(Doc, PushTokenId) ->
    kz_json:set_value([<<"push">>, <<"Token-ID">>], PushTokenId, Doc).

-spec push_token_proxy(doc()) -> kz_term:api_binary().
push_token_proxy(Doc) ->
    push_token_proxy(Doc, 'undefined').

-spec push_token_proxy(doc(), Default) -> binary() | Default.
push_token_proxy(Doc, Default) ->
    kz_json:get_binary_value([<<"push">>, <<"Token-Proxy">>], Doc, Default).

-spec set_push_token_proxy(doc(), binary()) -> doc().
set_push_token_proxy(Doc, PushTokenProxy) ->
    kz_json:set_value([<<"push">>, <<"Token-Proxy">>], PushTokenProxy, Doc).

-spec push_token_type(doc()) -> kz_term:api_binary().
push_token_type(Doc) ->
    push_token_type(Doc, 'undefined').

-spec push_token_type(doc(), Default) -> binary() | Default.
push_token_type(Doc, Default) ->
    kz_json:get_binary_value([<<"push">>, <<"Token-Type">>], Doc, Default).

-spec set_push_token_type(doc(), binary()) -> doc().
set_push_token_type(Doc, PushTokenType) ->
    kz_json:set_value([<<"push">>, <<"Token-Type">>], PushTokenType, Doc).

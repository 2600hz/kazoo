...
get_content_type(MediaType) ->
    get_content_type(MediaType, kz_term:truncate_left_binary(MediaType, 6)).

get_content_type(MediaType, <<"base64">>) ->
    get_content_type(kz_term:truncate_right_binary(MediaType, byte_size(MediaType) - 7), 'undefined');

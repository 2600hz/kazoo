...
get_default_limit(Key, Default) ->
    kapps_config:get_integer(?LIMITS_CAT, <<"default_", Key/binary>>, Default).
...
get_default_limit_units(Key, Default) ->
    case kapps_config:get(?LIMITS_CAT, <<"default_", Key/binary>>, Default) of
        Value when is_float(Value) -> kz_currency:dollars_to_units(abs(Value));
        Value when is_integer(Value) -> abs(Value);
...
get_default_limit_boolean(Key, Default) ->
    kapps_config:get_is_true(?LIMITS_CAT, <<"default_", Key/binary>>, Default).
...
get_default_limit_list(Key, Default) ->
    kapps_config:get_ne_binaries(?LIMITS_CAT, <<"default_", Key/binary>>, Default).

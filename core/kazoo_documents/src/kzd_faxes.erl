...
-export([notificationssms_send_to/1, notificationssms_send_to/2, set_notificationssms_send_to/2]).
...
-spec notificationssms_send_to(doc()) -> any().
-spec notificationssms_send_to(doc(), Default) -> any() | Default.
notificationssms_send_to(Doc) ->
    notificationssms_send_to(Doc, 'undefined').
notificationssms_send_to(Doc, Default) ->
    kz_json:get_value([[<<"notifications">>, <<"sms">>], <<"send_to">>], Doc, Default).

-spec set_notificationssms_send_to(doc(), any()) -> doc().
set_notificationssms_send_to(Doc, NotificationssmsSendTo) ->

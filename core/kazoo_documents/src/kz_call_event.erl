...
-spec other_leg_call_id(kz_json:object()) -> api(binary()).
other_leg_call_id(JObj) ->
    kz_json:get_value(<<"Other-Leg-Call-ID">>, JObj).

-spec other_leg_destination_number(kz_json:object()) -> api(binary()).
...
-spec replaced_by(kz_json:object()) -> api(binary()).
replaced_by(JObj) ->
...
-spec authorizing_id(kz_json:object()) -> api(binary()).
authorizing_id(JObj) ->
    custom_channel_var(JObj, <<"Authorizing-ID">>).

-spec authorizing_type(kz_json:object()) -> api(binary()).
authorizing_type(JObj) ->
    custom_channel_var(JObj, <<"Authorizing-Type">>).

-spec dtmf_digit(kz_json:object()) -> api(binary()).
dtmf_digit(JObj) ->
...
-spec hangup_cause(kz_json:object()) -> api(binary()).
hangup_cause(JObj) ->
    kz_json:get_value(<<"Hangup-Cause">>, JObj).

-spec hangup_code(kz_json:object()) -> api(binary()).
hangup_code(JObj) ->
    kz_json:get_value(<<"Hangup-Code">>, JObj).

-spec disposition(kz_json:object()) -> api(binary()).
disposition(JObj) ->
    kz_json:get_value(<<"Disposition">>, JObj).

-spec application_name(kz_json:object()) -> api(binary()).
application_name(JObj) ->
    kz_json:get_value(<<"Application-Name">>, JObj).

-spec application_event(kz_json:object()) -> api(binary()).
...
-spec application_response(kz_json:object()) -> api(binary()).
application_response(JObj) ->
    kz_json:get_value(<<"Application-Response">>, JObj).

-spec response_message(kz_json:object()) -> api(binary()).
response_message(JObj) ->
    kz_json:get_value(<<"Response-Message">>, JObj).

-spec response_code(kz_json:object()) -> api(binary()).
response_code(JObj) ->
...
-spec owner_id(kz_json:object()) -> api(binary()).
owner_id(JObj) ->
...
-spec error_message(kz_json:object()) -> api(binary()).
error_message(JObj) ->

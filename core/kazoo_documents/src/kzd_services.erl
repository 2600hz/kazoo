...
-spec billing_id(doc()) -> maybe(binary()).
...
-spec set_billing_id(doc(), maybe(binary())) -> doc().
...
-spec reseller_id(doc()) -> maybe(binary()).
...
-spec plan_account_id(doc(), ne_binary()) -> maybe(binary()).
-spec plan_account_id(doc(), ne_binary(), Default) -> maybe(binary()) | Default.
...
-spec set_reseller_id(doc(), maybe(binary())) -> doc().
...
-spec set_status(doc(), maybe(binary())) -> doc().
...
-spec set_plan(doc(), ne_binary(), maybe(kz_json:object())) -> doc().

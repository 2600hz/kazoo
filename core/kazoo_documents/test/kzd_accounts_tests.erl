...
account_formats_test_() ->
    ...
    Funs = [{fun kzd_accounts:format_account_id/1, AccountId}
           ...
           ,{fun kzd_accounts:format_account_db/1, AccountDbEn}
           ,{fun kzd_accounts:format_account_mod_id/1, MODbEn}
           ,{fun ?MODULE:format_account_mod_id_from_year_month/1, MODbEn}
           ,{fun ?MODULE:format_account_mod_id_from_now/1, MODbEn}
           ,{fun kzd_accounts:format_account_modb/1, MODbId}
    ...
    [{format_title(Fun, Format, Expected)
     ...
     || {Fun, Expected} <- Funs,
        ...
        [?_assertEqual('undefined', kzd_accounts:format_account_id('undefined', 'raw'))
        ,?_assertEqual(<<"accounts">>, kzd_accounts:format_account_id(<<"accounts">>, 'raw'))
        ,?_assertEqual(MODbEn, kzd_accounts:format_account_id(AccountDbEn, TS))
        ,?_assertEqual(MODbEn, kzd_accounts:format_account_mod_id(AccountDbEn, TS))
        ,?_assertEqual('undefined', kzd_accounts:format_account_id('undefined', Year, Month))
        ,?_assertEqual(MODbEn, kzd_accounts:format_account_id(AccountDbEn, Year, Month))
        ,?_assertEqual(MODbEn, kzd_accounts:format_account_id(AccountDbEn, Year, M))
        ,?_assertEqual(?KZ_TASKS_DB, kzd_accounts:format_account_id(?KZ_TASKS_DB, 'raw'))
        ,?_assertEqual(<<"bla">>, kzd_accounts:format_account_id(<<"bla">>, 'raw'))
        ].
...
is_simple_modb_converter("fun kzd_accounts:format_account_modb/1"++_) -> 'true';
is_simple_modb_converter("fun "?MODULE_STRING":format_account_modb_raw/1"++_) -> 'true';
is_simple_modb_converter("fun "?MODULE_STRING":format_account_modb_encoded/1"++_) -> 'true';
is_simple_modb_converter("fun "?MODULE_STRING":format_account_modb_unencoded/1"++_) -> 'true';
...
format_account_id_raw(F) -> kzd_accounts:format_account_id(F, 'raw').
format_account_id_encoded(F) -> kzd_accounts:format_account_id(F, 'encoded').
format_account_id_unencoded(F) -> kzd_accounts:format_account_id(F, 'unencoded').
format_account_mod_id_from_year_month(F) ->
    {Year, Month, _} = erlang:date(),
    kzd_accounts:format_account_mod_id(F, Year, Month).
format_account_mod_id_from_now(F) ->
    kzd_accounts:format_account_mod_id(F, os:timestamp()).
format_account_modb_raw(F) -> kzd_accounts:format_account_modb(F, 'raw').
format_account_modb_encoded(F) -> kzd_accounts:format_account_modb(F, 'encoded').
format_account_modb_unencoded(F) -> kzd_accounts:format_account_modb(F, 'unencoded').

...
%% @end
%%--------------------------------------------------------------------
-spec render(atom(), wh_proplist()) -> template_result().
-spec render(template(), atom(), wh_proplist()) -> template_result().
-spec render(template(), atom(), wh_proplist(), wh_proplist()) -> template_result().
...
-spec compile(template(), atom(), wh_proplist()) -> template_result().
...
%% @end
%%--------------------------------------------------------------------
-spec render_template(atom(), wh_proplist()) -> template_result().
render_template(Module, TemplateData) ->

...
-spec plan(ne_binary(), maybe(binary()), maybe(binary())) -> map().
...
-spec dataplan_match(ne_binary(), map(), maybe(binary())) -> map().
...
-spec dataplan_type_match(ne_binary(), ne_binary(), map(), maybe(binary())) -> map().

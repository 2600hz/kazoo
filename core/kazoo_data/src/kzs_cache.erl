...
-spec maybe_cache_failure(ne_binary(), ne_binary(), kz_proplist(), error()) -> 'ok'.
-spec maybe_cache_failure(ne_binary(), ne_binary(), kz_proplist(), error(), atoms()) -> 'ok'.
...
-spec add_to_doc_cache(ne_binary(), ne_binary(), kz_json:object() | error()) -> 'ok'.
...
-spec cache_if_not_media(kz_proplist(), ne_binary(), ne_binary(), kz_json:object() | error()) -> 'ok'.
cache_if_not_media(CacheProps, DbName, DocId, CacheValue) ->

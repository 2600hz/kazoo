...
%% @end
%%--------------------------------------------------------------------
-spec get_id(subscription()) -> api(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec update_addon_amount(subscription(), ne_binary(), api(binary()) | number()) -> subscription().
...
%% @public
-spec get_payment_token(subscription()) -> api(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec update_addon_quantity(subscription() | ne_binary(), ne_binary(), integer() | api(binary())) ->
                                   subscription().

...
-spec media_path(api(binary())) -> api(binary()).
-spec media_path(api(binary()), api(binary()) | kapps_call:call()) -> api(binary()).
...
-spec prompt_path(api(binary()), ne_binary()) -> ne_binary().
...
-spec prompt_id(ne_binary(), api(binary())) -> ne_binary().
...
-spec get_prompt(ne_binary()) -> api(binary()).
-spec get_prompt(ne_binary(), api(binary()) | kapps_call:call()) ->
                        api(binary()).
-spec get_prompt(ne_binary(), api(binary()), api(binary()) | kapps_call:call()) ->
                        api(binary()).
-spec get_prompt(ne_binary(), api(binary()), api(binary()), boolean()) -> api(binary()).
...
-spec get_account_prompt(ne_binary(), api(binary()), kapps_call:call()) -> api(binary()).
-spec get_account_prompt(ne_binary(), api(binary()), kapps_call:call(), ne_binary()) -> api(binary()).
...
-spec get_system_prompt(ne_binary(), api(binary())) -> api(binary()).
...
-spec default_prompt_language(api(binary())) -> ne_binary().
...
-spec prompt_language(api(binary())) -> ne_binary().
...
-spec prompt_language(api(binary()), api(binary())) -> ne_binary().

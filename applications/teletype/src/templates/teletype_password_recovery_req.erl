...
%%% @contributors
%%%-------------------------------------------------------------------
-module(teletype_password_recovery_req).

-export([init/0
         ,handle_password_recovery_req/2
        ]).
...
-define(TEMPLATE_ID, <<"password_recovery_req">>).
...
-define(TEMPLATE_NAME, <<"Password Recovery Request">>).
...
-spec handle_password_recovery_req(wh_json:object(), wh_proplist()) -> 'ok'.
handle_password_recovery_req(JObj, _Props) ->

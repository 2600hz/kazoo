...
-spec rm_call_binding(maybe(binary()) | kapps_call:call()) -> 'ok'.
...
-spec rm_call_binding(maybe(binary()), ne_binaries()) -> 'ok'.
...
-spec maybe_remove_binding(server_ref(), atom(), kz_proplist(), maybe(binary())) -> 'ok'.

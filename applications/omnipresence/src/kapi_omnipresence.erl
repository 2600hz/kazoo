...
-spec publish_update(ne_binary(), api(terms())) -> 'ok'.
...
%% @end
%%--------------------------------------------------------------------
-spec notify(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec notify_v(api(terms())) -> boolean().
...
-spec search_req_routing_key(binary() | api(terms())) -> ne_binary().
...
%% @end
%%--------------------------------------------------------------------
-spec search_partial_resp(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec search_partial_resp_v(api(terms())) -> boolean().
...
-spec publish_search_partial_resp(ne_binary(), api(terms())) -> 'ok'.
-spec publish_search_partial_resp(ne_binary(), api(terms()), binary()) -> 'ok'.

...
-spec publish_update(cb_context:context(), maybe(binary()), function()) -> 'ok'.
...
-spec fetch_agent_status(maybe(binary()), cb_context:context()) -> cb_context:context().
fetch_agent_status(AgentId, Context) ->
...
-spec fetch_all_current_stats(cb_context:context(), maybe(binary())) -> cb_context:context().
...
-spec fetch_all_current_statuses(cb_context:context(), maybe(binary()), maybe(binary())) ->
                                        cb_context:context().
...
-spec maybe_add_answered(kz_json:object(), kz_json:object(), maybe(binary())) ->
                                [{kz_json:key(), non_neg_integer()}].
...
-spec validate_status_change(cb_context:context(), maybe(binary())) ->
                                    cb_context:context().
...
-spec check_for_status_error(cb_context:context(), maybe(binary())) ->
                                    cb_context:context().

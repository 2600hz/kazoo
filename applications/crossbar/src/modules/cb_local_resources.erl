...
-spec check_for_registering_gateways(maybe(binary()), cb_context:context()) -> cb_context:context().
check_for_registering_gateways(ResourceId, Context) ->
...
-spec check_if_peer(maybe(binary()), cb_context:context()) -> cb_context:context().
check_if_peer(ResourceId, Context) ->
...
-spec check_if_gateways_have_ip(maybe(binary()), cb_context:context()) -> cb_context:context().
check_if_gateways_have_ip(ResourceId, Context) ->
...
-spec validate_gateway_ips(gateway_ips(), sip_auth_ips(), acl_ips(), maybe(binary()), cb_context:context(), crossbar_status()) -> cb_context:context().
...
-spec check_resource_schema(maybe(binary()), cb_context:context()) -> cb_context:context().
check_resource_schema(ResourceId, Context) ->
...
-type gateway_ip() :: {non_neg_integer(), maybe(binary()), maybe(binary())}.
...
-spec validate_ip(maybe(binary()), sip_auth_ips(), acl_ips(), maybe(binary())) -> boolean().

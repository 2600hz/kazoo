...
%% @end
%%--------------------------------------------------------------------
-type view_option_fun() :: fun((maybe(binary()), cb_context:context(), gregorian_seconds(), gregorian_seconds()) -> {'ok', crossbar_doc:view_options()}).

-spec create_view_options(maybe(binary()), cb_context:context()) ->
                                 {'ok', crossbar_doc:view_options()} |
                                 cb_context:context().
-spec create_view_options(maybe(binary()), view_option_fun(), cb_context:context()) ->
                                 {'ok', crossbar_doc:view_options()} |
                                 cb_context:context().
...
-spec create_view_options(maybe(binary()), cb_context:context(), gregorian_seconds(), gregorian_seconds()) ->
                                 {'ok', crossbar_doc:view_options()}.
...
-spec create_interaction_view_options(maybe(binary()), cb_context:context(), pos_integer(), pos_integer()) ->
                                 {'ok', crossbar_doc:view_options()}.

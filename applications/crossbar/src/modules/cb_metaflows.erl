...
-spec thing_doc(cb_context:context()) -> maybe(kz_json:object()).
-spec thing_doc(cb_context:context(), ne_binary()) -> maybe(kz_json:object()).
thing_doc(Context) ->
...
-spec validate_get_metaflows(cb_context:context(), maybe(kz_json:object())) -> cb_context:context().
...
-spec validate_delete_metaflows(cb_context:context(), maybe(kz_json:object())) -> cb_context:context().
...
-spec validate_set_metaflows(cb_context:context()) ->
                                    cb_context:context().
-spec validate_set_metaflows(cb_context:context(), kz_json:object(), maybe(kz_json:object())) ->
                                    cb_context:context().

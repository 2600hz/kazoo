...
-spec maybe_create_number(kz_json:object(), ne_binary(), ne_binary(), api(binary()), ne_binary()) ->
                                 kz_json:object().
...
-spec create_number(kz_json:object(), ne_binary(), ne_binary(), api(binary()), ne_binary()) ->
                           kz_json:object().

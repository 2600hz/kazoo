...
%% @end
%%--------------------------------------------------------------------
-spec validate_search(cb_context:context(), api(binary())) -> cb_context:context().
-spec validate_search(cb_context:context(), ne_binary(), api(binary())) ->
                             cb_context:context().
-spec validate_search(cb_context:context(), ne_binary(), ne_binary(), api(binary())) ->
                             cb_context:context().
...
%% @end
%%--------------------------------------------------------------------
-spec validate_multi(cb_context:context(), api(binary())) -> cb_context:context().

...
%%%
%%% To play in browser:
%%% https://my_crossbar.tld:8443/v1/accounts/33ca...1452/recordings/201412-6471-8c79ae@192.1.1.2/attachment?inline=true&auth_token=05c1...7a075
%%%
%%% To download:
%%% https://my_crossbar.tld:8443/v1/accounts/33ca...1452/recordings/201412-6471-8c79ae@192.1.1.2/attachment?auth_token=05c1...7a075
%%%
%%% @end
%%% @contributors:
%%%
...
allowed_methods(_Id ) -> [?HTTP_GET].
allowed_methods(_Id, ?ATTACHMENT) -> [?HTTP_GET].

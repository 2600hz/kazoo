...
-spec normalize_result(api(binary()), gregorian_seconds(), gregorian_seconds(), kz_json:object(), kz_json:objects())
                      -> kz_json:object().
...
-spec create_viewoptions(cb_context:context(), api(binary()), kz_json:object(), mode()) -> {api(binary()), kz_proplist()} |
                                                                                          cb_context:context().

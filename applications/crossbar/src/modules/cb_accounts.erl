...
%% @end
%%--------------------------------------------------------------------
-spec prepare_context(maybe(binary()), cb_context:context()) -> cb_context:context().
...
%% @end
%%--------------------------------------------------------------------
-spec validate_request(maybe(binary()), cb_context:context()) ->
                              cb_context:context().
...
-spec ensure_account_has_realm(maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec remove_spaces(maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec cleanup_leaky_keys(maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec validate_realm_is_unique(maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec validate_account_name_is_unique(maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec validate_account_schema(maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec maybe_import_enabled(cb_context:context(), crossbar_status()) ->
                                  cb_context:context().
-spec maybe_import_enabled(cb_context:context(), kz_json:object(), maybe(binary())) ->
                                  cb_context:context().
...
-spec disallow_direct_clients(maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec maybe_disallow_direct_clients(maybe(binary()), cb_context:context(), boolean()) ->
                                           cb_context:context().
...
-spec leak_notification_preference(cb_context:context(), maybe(binary())) -> cb_context:context().
...
-spec leak_trial_time_left(cb_context:context()) ->
                                  cb_context:context().
-spec leak_trial_time_left(cb_context:context(), kz_json:object(), maybe(integer())) ->
                                  cb_context:context().
...
-spec fix_start_key(maybe(binary()) | list()) -> maybe(binary()).
...
-spec create_new_tree(cb_context:context() | maybe(binary())) -> ne_binaries() | 'error'.
...
%% @end
%%--------------------------------------------------------------------
-spec is_unique_realm(maybe(binary()), ne_binary()) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec maybe_is_unique_account_name(maybe(binary()), ne_binary()) -> boolean().
...
-spec is_unique_account_name(maybe(binary()), ne_binary()) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec support_depreciated_billing_id(maybe(binary()), maybe(binary()), cb_context:context()) ->
                                            cb_context:context().

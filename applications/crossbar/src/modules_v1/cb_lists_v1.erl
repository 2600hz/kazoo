...
-spec check_list_schema(api(binary()), cb_context:context()) -> cb_context:context().
check_list_schema(ListId, Context) ->
...
-spec check_list_entry_schema(path_token(), api(binary()), cb_context:context()) -> cb_context:context().
check_list_entry_schema(ListId, EntryId, Context) ->

...
-spec validate_user_id(maybe(binary()), cb_context:context()) -> cb_context:context().
-spec validate_user_id(maybe(binary()), cb_context:context(), kz_json:object()) -> cb_context:context().
...
%% @end
%%--------------------------------------------------------------------
-spec load_user(maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec prepare_username(maybe(binary()), cb_context:context()) -> cb_context:context().
prepare_username(UserId, Context) ->
...
-spec check_user_name(maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec is_username_unique(maybe(binary()), maybe(binary()), ne_binary()) -> boolean().
...
-spec check_user_schema(maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec maybe_import_credintials(maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec maybe_validate_username(maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec maybe_rehash_creds(maybe(binary()), maybe(binary()), cb_context:context()) -> cb_context:context().
...
-spec manditory_rehash_creds(maybe(binary()), maybe(binary()), cb_context:context()) ->
                                    cb_context:context().
...
-spec rehash_creds(maybe(binary()), maybe(binary()), ne_binary(), cb_context:context()) ->
                          cb_context:context().
...
%% @end
%%--------------------------------------------------------------------
-spec username_doc_id(maybe(binary()), cb_context:context()) -> maybe(binary()).

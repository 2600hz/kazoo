...
%% @end
-spec migrate_old_entry_docs(ne_binary(), kz_json:object()) -> 'ok'.
...
%% @end
-spec migrate_old_entry_doc(ne_binary(), ne_binary(), kz_json:object()) -> kz_json:object().
...
-spec migrate_to_entry_doc(ne_binary(), ne_binary(), kz_json:object(), kz_json:object()) -> kz_json:object().

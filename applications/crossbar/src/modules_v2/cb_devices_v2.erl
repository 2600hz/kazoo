...
-spec validate_device_id(cb_context:context(), api(binary())) -> cb_context:context().
...
-spec maybe_check_mdn(api(binary()), cb_context:context()) -> cb_context:context().
...
-spec check_mdn_undefined(api(binary()), cb_context:context()) -> cb_context:context().
...
-spec check_mdn_changed(api(binary()), cb_context:context()) -> cb_context:context().
...
-spec check_mdn_taken(api(binary()), cb_context:context()) -> cb_context:context().
...
-spec check_mdn_registered(api(binary()), cb_context:context()) -> cb_context:context().
check_mdn_registered(DeviceId, Context) ->
...
-spec prepare_outbound_flags(api(binary()), cb_context:context()) -> cb_context:context().
prepare_outbound_flags(DeviceId, Context) ->
...
-spec validate_device_creds(api(binary()), api(binary()), cb_context:context()) -> cb_context:context().
...
-spec validate_device_password(ne_binary(), api(binary()), cb_context:context()) -> cb_context:context().
validate_device_password(Realm, DeviceId, Context) ->
...
-spec check_device_type_change(api(binary()), cb_context:context()) -> cb_context:context().
...
-spec error_device_type_change(api(binary()), cb_context:context()) -> cb_context:context().
...
-spec check_device_schema(api(binary()), cb_context:context()) -> cb_context:context().
...
%% @end
%%--------------------------------------------------------------------
-spec get_device_type(cb_context:context()) -> api(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec get_mdn(cb_context:context()) -> api(binary()).
get_mdn(Context) ->

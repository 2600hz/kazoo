...
-spec validate_phone_numbers(cb_context:context(), http_method(), maybe(binary())) ->
                                    cb_context:context().
...
-spec classified_number(cb_context:context(), path_token(), maybe(binary())) -> cb_context:context().

...
> DELETE /v2/accounts/{ACCOUNT_ID}/storage/plans/{PLAN_ID}

```shell
curl -v -X DELETE \
    -H "X-Auth-Token: {AUTH_TOKEN}" \
    http://{SERVER}:8000/v2/accounts/{ACCOUNT_ID}/storage/plans/{PLAN_ID}
```

#### Fetch

> GET /v2/accounts/{ACCOUNT_ID}/storage/plans/{PLAN_ID}
...
> POST /v2/accounts/{ACCOUNT_ID}/storage/plans/{PLAN_ID}

...
## Get port request comments

### Request

- Verb: `GET`
- Url: `/accounts/{{ACCOUNT_ID}}/port_requests/{{PORT_REQUEST_ID}}/comments`
- Payload: None
...
```json
{
    "data": {
        "comments": [{
            "user_id": "{{USER_ID}}",
            "timestamp": 63607675803,
            "content": "test",
            "superduper_comment": false,
        }, {
            "user_id": "{{USER_ID}}",
            "timestamp": 63607678676,
            "content": "test 2",
            "superduper_comment": false
        }, {
            "user_id": "{{USER_ID}}",
            "timestamp": 63617678676,
            "content": "test 3",
            "superduper_comment": false
        }, {
            "user_id": "{{USER_ID}}",
            "timestamp": 63627678676,
            "content": "test 5",
            "superduper_comment": false
        }]
    },

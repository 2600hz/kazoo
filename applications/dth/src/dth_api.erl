...
%% @end
%%--------------------------------------------------------------------
-spec blacklist_req(api(terms())) -> {'ok', iolist()} |
                                          {'error', string()}.
...
-spec blacklist_req_v(api(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec blacklist_resp(api(terms())) -> {'ok', iolist()} |
                                           {'error', string()}.
...
-spec blacklist_resp_v(api(terms())) -> boolean().

...
%% @end
%%--------------------------------------------------------------------
-spec blacklist_req(maybe(terms())) -> {'ok', iolist()} |
                                          {'error', string()}.
...
-spec blacklist_req_v(maybe(terms())) -> boolean().
...
%% @end
%%--------------------------------------------------------------------
-spec blacklist_resp(maybe(terms())) -> {'ok', iolist()} |
                                           {'error', string()}.
...
-spec blacklist_resp_v(maybe(terms())) -> boolean().

...
%% @end
%%--------------------------------------------------------------------
-spec get_realm(api(binary()) | kz_json:object()) -> api(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec correct_shortdial(ne_binary(), ne_binary() | kapi_offnet_resource:req()) -> api(binary()).
...
-spec get_diversions(api(binary()), ne_binaries()) -> api(ne_binaries()).
...
-spec format_endpoints(kz_json:objects(), api(binary()), api(binary()), kapi_offnet_resource:req(), filter_fun()) ->
                              kz_json:objects().
...
-spec default_realm(kapi_offnet_resource:req()) -> api(binary()).
...
-spec set_endpoint_caller_id(kz_json:object(), api(binary()), api(binary())) -> kz_json:object().
...
-spec format_endpoint(kz_json:object(), api(binary()), filter_fun(), kapi_offnet_resource:req(), kz_json:object(), ne_binary()) ->
                             kz_json:object().
...
-spec endpoint_props(kz_json:object(), api(binary())) -> kz_proplist().
endpoint_props(Endpoint, AccountId) ->
...
-spec get_endpoint_format_from(kapi_offnet_resource:req(), kz_json:object()) -> api(binary()).

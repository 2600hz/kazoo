...
-spec maybe_deny_emergency_bridge(state(), maybe(binary()), maybe(binary())) -> 'ok'.
...
-spec build_bridge(state(), maybe(binary()), maybe(binary())) -> kz_proplist().
...
-spec bridge_outbound_cid_name(kapi_offnet_resource:req()) -> maybe(binary()).
...
-spec bridge_outbound_cid_number(kapi_offnet_resource:req()) -> maybe(binary()).
...
-spec bridge_emergency_cid_name(kapi_offnet_resource:req()) -> maybe(binary()).
...
-spec bridge_emergency_cid_number(kapi_offnet_resource:req()) -> maybe(binary()).
...
-spec find_emergency_number(kapi_offnet_resource:req()) -> maybe(binary()).
...
-spec ensure_valid_emergency_number(kapi_offnet_resource:req()) -> maybe(binary()).
...
-spec find_valid_emergency_number(ne_binaries()) -> maybe(binary()).

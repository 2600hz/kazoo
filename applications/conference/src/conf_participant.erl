...
join_conference('true'=_Moderator, ParticipantNo, Conference) ->
    lager:debug("caller has joined the local conference as moderator ~p", [ParticipantNo]),
...
join_conference('false'=_Moderator, ParticipantNo, Conference) ->
    lager:debug("caller has joined the local conference as member ~p", [ParticipantNo]),

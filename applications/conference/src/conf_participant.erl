...
-spec sync_participant(kz_json:objects(), kapps_call:call(), participant()) -> participant().
sync_participant(JObj, Call, P=#participant{in_conference='false', conference=Conference, discovery_event=DiscoveryEvent}) ->
    ...
    P#participant{in_conference='true'
                  ,participant_id=ParticipantId
                  ,muted=(not kz_json:is_true(<<"Speak">>, JObj))
                  ,deaf=(not kz_json:is_true(<<"Hear">>, JObj))
                 };

sync_participant(JObj, _Call, P=#participant{in_conference='true'}) ->

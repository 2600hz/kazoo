...
-spec maybe_get_presence_id(auth_user()) -> api(binary()).
...
-spec get_presence_id(api(binary()), api(binary()), api(binary())) -> api(binary()).
...
-spec maybe_get_owner_presence_id(ne_binary(), ne_binary(), ne_binary()) -> api(binary()).
maybe_get_owner_presence_id(AccountDb, DeviceId, OwnerId) ->
...
-spec get_device_presence_id(ne_binary(), ne_binary()) -> api(binary()).
get_device_presence_id(AccountDb, DeviceId) ->
...
-spec get_tel_uri(api(binary())) -> api(binary()).
...
-spec maybe_update_gsm(api(binary()), auth_user()) -> auth_user().
...
%% @end
%%-----------------------------------------------------------------------------
-spec get_account_id(kz_json:object()) -> api(binary()).
get_account_id(JObj) ->
...
%% @end
%%-----------------------------------------------------------------------------
-spec get_account_db(kz_json:object()) -> api(binary()).
get_account_db(JObj) ->

...
-spec ratelimits_resp(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec ratelimits_req_v(maybe(terms())) -> boolean().
...
-spec ratelimits_resp_v(maybe(terms())) -> boolean().
...
-spec acls_resp(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec acls_req_v(maybe(terms())) -> boolean().
...
-spec acls_resp_v(maybe(terms())) -> boolean().

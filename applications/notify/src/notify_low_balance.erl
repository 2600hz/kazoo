...
%% @end
%%--------------------------------------------------------------------
-spec collect_recipients(ne_binary()) -> maybe([maybe(binary())]) | maybe(binary()).
collect_recipients(AccountId) ->
    {'ok', MasterAccountId} = kapps_util:get_master_account_id(),
    get_email(AccountId, MasterAccountId).

-spec get_email(ne_binary(), ne_binary()) -> maybe([maybe(binary())]) | maybe(binary()).
...
-spec get_email(kz_json:object(), ne_binary(), ne_binary()) -> maybe([maybe(binary())]) | maybe(binary()).
...
-spec find_billing_email(kz_json:object()) -> maybe([maybe(binary())]) | maybe(binary()).

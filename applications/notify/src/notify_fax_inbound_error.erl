...
%%%-------------------------------------------------------------------
-module(notify_fax_inbound_error).

-export([init/0, handle_req/2]).

-include("notify.hrl").

-define(DEFAULT_TEXT_TMPL, 'notify_fax_inbound_error_text_tmpl').
-define(DEFAULT_HTML_TMPL, 'notify_fax_inbound_error_html_tmpl').
-define(DEFAULT_SUBJ_TMPL, 'notify_fax_inbound_error_subj_tmpl').

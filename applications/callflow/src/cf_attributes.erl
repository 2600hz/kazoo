...
-spec log_configured_endpoint_cid(ne_binary(), api(binary()), api(binary())) -> 'ok'.
...
-spec maybe_use_presence_number(api(binary()), api(binary()), kz_json:object(), boolean(), ne_binary(), kapps_call:call()) ->
                                 {api(binary()), api(binary())}.
...
-spec maybe_normalize_cid(api(binary()), api(binary()), boolean(), ne_binary(), kapps_call:call()) ->
                                 {api(binary()), api(binary())}.
...
-spec maybe_cid_privacy(api(binary()), api(binary()), kapps_call:call()) ->
                               {api(binary()), api(binary())}.
maybe_cid_privacy(Number, Name, Call) ->
...
-spec maybe_get_presence_number(kz_json:object(), kapps_call:call()) -> api(binary()).
...
%% @end
%%-----------------------------------------------------------------------------
-spec callee_id(api(binary()) | kz_json:object(), kapps_call:call()) ->
                       {api(binary()), api(binary())}.
...
-spec maybe_normalize_callee(api(binary()), api(binary()), kz_json:object(), kapps_call:call()) ->
                                    {api(binary()), api(binary())}.
...
%% @end
%%-----------------------------------------------------------------------------
-spec moh_attributes(ne_binary(), kapps_call:call()) -> api(binary()).
-spec moh_attributes(api(binary()) | kz_json:object(), ne_binary(), kapps_call:call()) -> api(binary()).
...
-spec maybe_normalize_moh_attribute(api(binary()), ne_binary(), kapps_call:call()) -> api(binary()).
...
%% @end
%%-----------------------------------------------------------------------------
-spec owner_id(kapps_call:call()) -> api(binary()).
-spec owner_id(api(binary()), kapps_call:call()) -> api(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec presence_id(kapps_call:call()) -> api(binary()).
presence_id(Call) ->
    presence_id(kapps_call:authorizing_id(Call), Call).

-spec presence_id(api(binary()) | kz_json:object(), kapps_call:call()) -> api(binary()).
...
-spec get_cid_or_default(ne_binary(), ne_binary(), kz_json:object()) -> api(binary()).

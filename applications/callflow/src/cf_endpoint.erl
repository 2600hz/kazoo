...
-spec get(api(binary()), ne_binary() | kapps_call:call()) -> cf_api_std_return().
...
-spec endpoint_type_as(api(binary())) -> api(binary()).
...
-spec get_user(ne_binary(), api(binary()) | kz_json:object()) -> kz_json:object().
...
-spec create_endpoint_name(api(binary()), api(binary()), api(binary()), api(binary())) -> api(binary()).
...
-spec maybe_missing_resource_type(api(binary())) ->
                                     'ok' |
                                     {'error', 'no_resource_type'}.
...
-spec maybe_owner_called_self(kz_json:object(), kz_json:object(), api(binary()), kapps_call:call()) ->
                                     'ok' |
                                     {'error', 'owner_called_self'}.
...
-spec maybe_endpoint_called_self(kz_json:object(), kz_json:object(), api(binary()), kapps_call:call()) ->
                                        'ok' |
                                        {'error', 'endpoint_called_self'}.
...
-spec convert_endpoint_type(ne_binary()) -> api(binary()).
...
%% @end
%%--------------------------------------------------------------------
-record(clid, {caller_number :: api(binary())
               ,caller_name :: api(binary())
               ,callee_name :: api(binary())
               ,callee_number :: api(binary())
              }).
-type clid() :: #clid{}.
...
%% @end
%%--------------------------------------------------------------------
-spec get_sip_transport(kz_json:object()) -> api(binary()).
...
-spec validate_sip_transport(any()) -> api(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec get_custom_sip_interface(kz_json:object()) -> api(binary()).
...
-spec maybe_add_diversion(kz_json:object(), kz_json:object(), api(binary()), kapps_call:call()) -> kz_json:object().
...
-spec maybe_add_alert_info(kz_json:object(), kz_json:object(), api(binary())) -> kz_json:object().
...
-spec maybe_add_aor(kz_json:object(), kz_json:object(), api(binary()), ne_binary()) -> kz_json:object().
...
-spec get_to_did(kz_json:object(), kapps_call:call()) -> api(binary()).
...
-spec get_to_user(kz_json:object(), kz_json:object()) -> api(binary()).
...
-spec get_to_username(kz_json:object()) -> api(binary()).
get_to_username(SIPJObj) ->
    kz_json:get_value(<<"username">>, SIPJObj).

-spec get_timeout(kz_json:object()) -> api(binary()).
get_timeout(JObj) ->
...
-spec get_delay(kz_json:object()) -> api(binary()).
get_delay(JObj) ->
...
-spec get_outbound_flags(kz_json:object()) -> api(binary()).
get_outbound_flags(JObj) ->
    kz_json:get_ne_value(<<"outbound_flags">>, JObj).

-spec get_progress_timeout(kz_json:object()) -> api(binary()).
...
-spec get_bypass_media(kz_json:object()) -> api(binary()).

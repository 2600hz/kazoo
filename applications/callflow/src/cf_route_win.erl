...
-spec should_restrict_call(api(binary()), kapps_call:call()) -> boolean().
...
-spec maybe_start_metaflow(kapps_call:call(), api(binary())) -> kapps_call:call().
...
-spec maybe_start_endpoint_metaflow(kapps_call:call(), api(binary())) -> 'ok'.

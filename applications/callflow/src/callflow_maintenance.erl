...
blocking_refresh() ->
    io:format("This function is deprecated please, kapps_maintenace:refresh() instead.").
...
refresh(Account) ->
    io:format("This function is deprecated please, kapps_maintenace:refresh(~p) instead.", [Account]).

...
%% @end
%%--------------------------------------------------------------------
-spec cf_toggle(callfwd(), api(binary()), kapps_call:call()) -> callfwd().
...
%% @end
%%--------------------------------------------------------------------
-spec cf_activate(callfwd(), api(binary()), kapps_call:call()) -> callfwd().
...
%% @end
%%--------------------------------------------------------------------
-spec cf_update_number(callfwd(), api(binary()), kapps_call:call()) -> callfwd().
...
-spec maybe_get_call_forward(kapps_call:call(), api(binary())) ->
                                    callfwd() |
                                    {'error', callfwd()}.

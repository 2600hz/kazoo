...
-spec build_flow_data(kapps_call:call(), kz_proplist(), maybe(binary())) -> kz_json:object().
...
-spec maybe_correct_target(target(), maybe(binary()), kapps_call:call()) ->
                                  boolean().
...
-spec lookup_endpoint(maybe(kz_json:object())) -> target().
-spec lookup_endpoint(kz_json:object(), maybe(binary())) -> target().

...
-spec login_authorizing_id(api(binary()), hotdesk(), kapps_call:call()) ->
                                  kapps_api_std_return().
...
-spec keep_logged_in_elsewhere(api(binary()), hotdesk(), kapps_call:call()) ->
                                      kapps_api_std_return().
...
%% @end
%%--------------------------------------------------------------------
-spec get_hotdesk_profile(api(binary()), kz_json:object(), kapps_call:call()) ->
                                 hotdesk() |
                                 {'error', any()}.
...
-spec update_hotdesk_endpoint(ne_binary(), api(binary()) | kz_json:object(), function()) ->
                                     kz_jobj_return().

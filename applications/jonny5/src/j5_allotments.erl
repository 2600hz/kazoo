...
-spec maybe_consume_allotment(maybe(kz_json:object()), j5_request:request(), j5_limits:limits()) -> j5_request:request().
...
%% @end
%%--------------------------------------------------------------------
-spec find_allotment(j5_request:request(), j5_limits:limits()) -> maybe(kz_json:object()).
...
-spec find_allotment_by_classification(ne_binary(), ne_binary(), j5_limits:limits()) -> maybe(kz_json:object()).
find_allotment_by_classification(Direction, Classification, Limits) ->
...
-spec find_allotment_by_classification(ne_binary(), j5_limits:limits()) -> maybe(kz_json:object()).
find_allotment_by_classification(Classification, Limits) ->

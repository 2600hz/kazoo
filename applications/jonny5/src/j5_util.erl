...
-spec remove_call_charges(api(binary()), api(binary())) -> 'ok'.
...
-spec add_limit_details(api(binary()), ne_binary(), kz_proplist()) -> kz_proplist().
...
-spec get_account_name(api(binary())) -> ne_binary().

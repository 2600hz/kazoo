...
-record(request, {account_id :: maybe(binary())
                  ,account_billing :: maybe(binary())
                  ,account_authorized = 'false' :: boolean()
                  ,reseller_id :: maybe(binary())
                  ,reseller_billing :: maybe(binary())
                  ,reseller_authorized = 'false' :: boolean()
                  ,soft_limit = 'false' :: boolean()
                  ,call_id :: maybe(binary())
                  ,call_direction :: maybe(binary())
                  ,other_leg_call_id :: maybe(binary())
                  ,sip_to :: maybe(binary())
                  ,sip_from :: maybe(binary())
                  ,sip_request :: maybe(binary())
                  ,message_id :: maybe(binary())
                  ,server_id :: maybe(binary())
                  ,node :: maybe(binary())
                  ,classification :: maybe(binary())
                  ,number :: maybe(binary())
...
%% @end
%%--------------------------------------------------------------------
-spec set_account_id(maybe(binary()), request()) -> request().
set_account_id(AccountId, Request) ->
    Request#request{account_id=AccountId}.

-spec account_id(request()) -> maybe(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec set_reseller_id(maybe(binary()), request()) -> request().
set_reseller_id(ResellerId, Request) ->
    Request#request{reseller_id=ResellerId}.

-spec reseller_id(request()) -> maybe(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec billing(request(), j5_limits:limits()) -> maybe(binary()).
...
-spec account_billing(request()) -> maybe(binary()).
account_billing(#request{account_billing=Billing}) -> Billing.

-spec reseller_billing(request()) -> maybe(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec other_leg_call_id(request()) -> maybe(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec answered_time(request()) -> maybe(non_neg_integer()).
...
%% @end
%%--------------------------------------------------------------------
-spec billing_seconds(request()) -> maybe(non_neg_integer()).
...
%% @end
%%--------------------------------------------------------------------
-spec call_direction(request()) -> maybe(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec call_id(request()) -> maybe(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec from(request()) -> maybe(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec message_id(request()) -> maybe(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec server_id(request()) -> maybe(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec node(request()) -> maybe(binary()).
...
%% @end
%%--------------------------------------------------------------------
-spec classification(request()) -> maybe(binary()).
...
-spec caller_network_address(request()) -> maybe(binary()).

...
-spec maybe_start_agent(api(binary()), api(binary())) ->
                               {'ok', pid()} |
                               {'exists', pid()} |
                               {'error', any()}.
...
-spec handle_new_channel_acct(kz_json:object(), api(binary())) -> 'ok'.
...
-spec presence_state(kz_json:object(), api(binary())) -> api(binary()).

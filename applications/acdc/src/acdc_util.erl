...
-spec presence_update(ne_binary(), ne_binary(), ne_binary(), api(binary())) -> 'ok'.
...
-spec agents_in_queue(ne_binary(), ne_binary()) -> kz_json:keys().
...
-spec bind_to_call_events(api(binary()) | {api(binary()), any()} | kapps_call:call()) -> 'ok'.
bind_to_call_events(Call) ->
    bind_to_call_events(Call, self()).

-spec bind_to_call_events(api(binary()) | {api(binary()), any()} | kapps_call:call(), pid()) -> 'ok'.
...
-spec unbind_from_call_events(api(binary()) | {api(binary()), any()} | kapps_call:call()) -> 'ok'.
unbind_from_call_events(Call) ->
    unbind_from_call_events(Call, self()).

-spec unbind_from_call_events(api(binary()) | {api(binary()), any()} | kapps_call:call(), pid()) -> 'ok'.

...
-spec sync_req(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec sync_resp(maybe(terms())) -> {'ok', iolist()} |
                                {'error', string()}.
...
-spec stats_req(maybe(terms())) -> {'ok', iolist()} |
                                {'error', string()}.
...
-spec stats_req_v(maybe(terms())) -> boolean().
...
-spec stats_req_routing_key(ne_binary(), maybe(binary())) -> ne_binary().
...
-spec stats_resp(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec stats_resp_v(maybe(terms())) -> boolean().
...
-spec login_v(maybe(terms())) -> boolean().
...
-spec login_queue_v(maybe(terms())) -> boolean().
...
-spec logout_v(maybe(terms())) -> boolean().
...
-spec logout_queue_v(maybe(terms())) -> boolean().
...
-spec pause_v(maybe(terms())) -> boolean().
...
-spec login_resp_v(maybe(terms())) -> boolean().
...
-spec bind_q(binary(), {ne_binary(), ne_binary(), ne_binary()}, maybe(list())) -> 'ok'.
bind_q(Q, Props) ->
...
-spec unbind_q(binary(), {ne_binary(), ne_binary(), ne_binary()}, maybe(list())) -> 'ok'.
unbind_q(Q, Props) ->
    AgentId = props:get_value('agent_id', Props, <<"*">>),
    AcctId = props:get_value('account_id', Props, <<"*">>),
    Status = props:get_value('status', Props, <<"*">>),
...
-spec publish_stats_req(maybe(terms())) -> 'ok'.
-spec publish_stats_req(maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_stats_resp(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_stats_resp(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_login(maybe(terms())) -> 'ok'.
-spec publish_login(maybe(terms()), ne_binary()) -> 'ok'.
publish_login(JObj) ->
...
-spec publish_logout(maybe(terms())) -> 'ok'.
-spec publish_logout(maybe(terms()), ne_binary()) -> 'ok'.
publish_logout(JObj) ->
...
-spec publish_login_queue(maybe(terms())) -> 'ok'.
-spec publish_login_queue(maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_logout_queue(maybe(terms())) -> 'ok'.
-spec publish_logout_queue(maybe(terms()), ne_binary()) -> 'ok'.
...
-spec publish_pause(maybe(terms())) -> 'ok'.
-spec publish_pause(maybe(terms()), ne_binary()) -> 'ok'.
publish_pause(JObj) ->
...
-spec publish_login_resp(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_login_resp(ne_binary(), maybe(terms()), ne_binary()) -> 'ok'.

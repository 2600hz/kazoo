...
%%% @end
%%%-----------------------------------------------------------------------------
-module(webhooks_qubicle_queue_join).
...
-define(HOOK_NAME, <<"qubicle_queue_join">>).
-define(NAME, <<"Qubicle Queue Join">>).
-define(DESC, <<"Fires when a session joins a queue">>).
-define(METADATA

...
%%% @end
%%%-----------------------------------------------------------------------------
-module(webhooks_qubicle_recipient_delivered).
...
-define(HOOK_NAME, <<"qubicle_recipient_delivered">>).
-define(NAME, <<"Qubicle Recipient Delivered">>).
-define(DESC, <<"Fires when a recipient is successfully delivered a session">>).
-define(METADATA

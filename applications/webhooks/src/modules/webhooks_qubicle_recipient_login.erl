...
%%% @end
%%%-----------------------------------------------------------------------------
-module(webhooks_qubicle_recipient_login).
...
-define(HOOK_NAME, <<"qubicle_recipient_login">>).
-define(NAME, <<"Qubicle Recipient Login">>).
-define(DESC, <<"Fires when a recipient logs in">>).
-define(METADATA

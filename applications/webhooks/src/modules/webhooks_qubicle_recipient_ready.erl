...
%%% @end
%%%-----------------------------------------------------------------------------
-module(webhooks_qubicle_recipient_ready).
...
-define(HOOK_NAME, <<"qubicle_recipient_ready">>).
-define(NAME, <<"Qubicle Recipient Ready">>).
-define(DESC, <<"Fires when a recipient goes ready">>).
-define(METADATA

...
%%% @end
%%%-----------------------------------------------------------------------------
-module(webhooks_qubicle_recipient_away).
...
-define(HOOK_NAME, <<"qubicle_recipient_away">>).
-define(NAME, <<"Qubicle Recipient Away">>).
-define(DESC, <<"Fires when a recipient sets themselves away">>).
-define(METADATA

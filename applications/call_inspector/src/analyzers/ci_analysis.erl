...
-spec call_id(analysis()) -> api(binary()).
...
-spec originate_type(analysis()) -> api(binary()).
...
-spec terminate_type(analysis()) -> api(binary()).
...
-spec failure_location(analysis()) -> api(binary()).
...
-spec reason(analysis()) -> api(binary()).

...
-spec lookup_req(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec lookup_req_v(maybe(terms())) -> boolean().
...
-spec lookup_resp(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec lookup_resp_v(maybe(terms())) -> boolean().
...
-spec filter_req(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec filter_req_v(maybe(terms())) -> boolean().
...
-spec filter_resp(maybe(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec filter_resp_v(maybe(terms())) -> boolean().
...
-spec publish_lookup_req(maybe(terms())) -> 'ok'.
-spec publish_lookup_req(maybe(terms()), binary()) -> 'ok'.
...
-spec publish_lookup_resp(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_lookup_resp(ne_binary(), maybe(terms()), binary()) -> 'ok'.
...
-spec publish_filter_req(maybe(terms())) -> 'ok'.
-spec publish_filter_req(maybe(terms()), binary()) -> 'ok'.
...
-spec publish_filter_resp(ne_binary(), maybe(terms())) -> 'ok'.
-spec publish_filter_resp(ne_binary(), maybe(terms()), binary()) -> 'ok'.

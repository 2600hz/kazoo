...
reorder_dialog_3_test_() ->
    Data = {fun chunks_3/0, fun chunks_3/1},
    reorder_dialog('10.26.0.182:9061', Data).
     ...
     {[{<<"call-id">>,<<"36-52896@10.26.0.167">>},
       ...
       {<<"raw">>,
        [<<"INVITE sip:service@10.26.0.182:5060 SIP/2.0">>,
         ...
         <<"From: sipp <sip:sipp@10.26.0.167:5060>;tag=52896SIPpTag0036">>,
         <<"To: service <sip:service@10.26.0.182:5060>">>,
         <<"Call-ID: 36-52896@10.26.0.167">>,<<"CSeq: 1 INVITE">>,
         <<"Contact: sip:sipp@10.26.0.167:5060">>,<<"Max-Forwards: 50">>,
         <<"Subject: Performance Test">>,<<"Content-Type: application/sdp">>,
         <<"Content-Length:   133">>,<<"X-AUTH-IP: 10.26.0.167">>,
         <<"X-AUTH-PORT: 5060">>,<<>>,<<"v=0">>,
         <<"o=user1 53655765 2353687637 IN IP4 10.26.0.167">>,<<"s=-">>,
         <<"c=IN IP4 10.26.0.167">>,<<"t=0 0">>,<<"m=audio 6000 RTP/AVP 0">>,
         <<"a=rtpmap:0 PCMU/8000">>]},
       {<<"src">>, <<"10.26.0.182:5060">>},
       {<<"dst">>, <<"10.26.0.182:11000">>},
       {<<"parser">>,'10.26.0.182:9061'}]},
     ...
     {[{<<"call-id">>,<<"36-52896@10.26.0.167">>},
       ...
       {<<"raw">>,
        [<<"ACK sip:service@10.26.0.182:5060 SIP/2.0">>,
         ...
         <<"From: sipp <sip:sipp@10.26.0.167:5060>;tag=52896SIPpTag0036">>,
         <<"To: service <sip:service@10.26.0.182:5060>;tag=8DZD96F5HDKmj">>,
         <<"Call-ID: 36-52896@10.26.0.167">>,<<"CSeq: 1 ACK">>,

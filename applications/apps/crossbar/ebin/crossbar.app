{application,crossbar,
             [{description,"Crossbar - REST Interface to the stars"},
              ...
              {modules,[accounts,api_auth,callflows,clicktocall,conferences,
                        ...
                        crossbar_validator,devices,evtsub,fixtures,media,
                        menus,noauthn,noauthz,plists,registrations,resources,
                        servers,signup,simple_authz,static_resource,t_evtsub,
                        t_fixtures,token_auth,user_auth,users,v1_resource,
                        vmboxes]},
              {registered,[]},

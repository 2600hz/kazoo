...
notify_failure(JObj, Reason, #state{call=Call
    ...
    kapi_notify_publisher:cast(Message, fun kapi_notifications:publish_fax_inbound_error/1).
...
notify_success(#state{call=Call
    ...
    kapi_notify_publisher:cast(Message, fun kapi_notifications:publish_fax_inbound/1).

...
-spec query_status(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec query_status_v(api(terms())) -> boolean().
...
-spec status(api(terms())) -> {'ok', iolist()} | {'error', string()}.
...
-spec status_v(api(terms())) -> boolean().
...
-spec publish_query_status(ne_binary(), api(terms())) -> 'ok'.
-spec publish_query_status(ne_binary(), api(terms()), ne_binary()) -> 'ok'.
...
-spec publish_status(api(terms())) -> 'ok'.
-spec publish_status(api(terms()), ne_binary()) -> 'ok'.
publish_status(API) ->
...
-spec publish_targeted_status(ne_binary(), api(terms())) -> 'ok'.
-spec publish_targeted_status(ne_binary(), api(terms()), ne_binary()) -> 'ok'.

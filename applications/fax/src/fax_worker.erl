...
maybe_notify(JObj, Resp, <<"completed">>) ->
    ...
    kapi_notify_publisher:cast(Message, fun kapi_notifications:publish_fax_outbound/1);
maybe_notify(JObj, Resp, <<"failed">>) ->
    ...
    kapi_notify_publisher:cast(Message, fun kapi_notifications:publish_fax_outbound_error/1);

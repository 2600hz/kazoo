...
-spec maybe_serialize(ne_binary(), ne_binary(), ne_binary(), ne_binary(), ne_binary(), kz_json:object(), map()) -> map().
...
-spec handle_job_error(ne_binary(), ne_binary(), kz_json:object(), map()) -> map().
...
-spec handle_job_start(ne_binary(), ne_binary(), kz_json:object(), map()) -> map().
...
-spec handle_job_end(ne_binary(), ne_binary(), kz_json:object(), map()) -> map().

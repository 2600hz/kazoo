...
|`use_http_cache`|boolean()|`true`|Toggle ussage of mod_http_cache for media streaming
...
|`fs_cmds`|json\_object()|`[{"load":"mod_sofia"},{"reloadacl":""}]`|What comands to run on a FreeSWITCH server when connecting for the first time

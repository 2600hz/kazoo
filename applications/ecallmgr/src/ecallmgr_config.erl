...
-spec flush() -> 'ok'.
-spec flush(kz_json:keys()) -> 'ok' | {'error', any()}.
...
-spec get(kz_json:keys()) -> kz_json:json_term() | 'undefined'.
-spec get(kz_json:keys(), Default) -> kz_json:json_term() | Default.
-spec get(kz_json:keys(), Default, kz_json:keys() | atom()) -> kz_json:json_term() | Default.
...
-spec get_default(kz_json:keys()) -> kz_json:json_term() | 'undefined'.
-spec get_default(kz_json:keys(), Default) -> kz_json:json_term() | Default.
get_default(Key) ->
    get(Key, 'undefined', <<"default">>).
get_default(Key, Default) ->
    get(Key, Default, <<"default">>).

-spec get_integer(kz_json:keys()) -> api_integer().
-spec get_integer(kz_json:keys(), Default) -> integer() | Default.
-spec get_integer(kz_json:keys(), Default, kz_json:keys() | atom()) -> integer() | Default.
get_integer(Key) ->
...
-spec get_boolean(kz_json:keys()) -> api_boolean().
-spec get_boolean(kz_json:keys(), Default) -> boolean() | Default.
-spec get_boolean(kz_json:keys(), Default, kz_json:keys() | atom()) -> boolean() | Default.
get_boolean(Key) ->
...
-spec is_true(kz_json:keys()) -> boolean().
-spec is_true(kz_json:keys(), Default) -> boolean() | Default.
-spec is_true(kz_json:keys(), Default, kz_json:keys() | atom()) -> boolean() | Default.
is_true(Key) ->
...
-spec fetch(kz_json:keys()) -> kz_json:json_term() | 'undefined'.
-spec fetch(kz_json:keys(), Default) -> kz_json:json_term() | Default.
-spec fetch(kz_json:keys(), Default, kz_json:keys() | atom()) -> kz_json:json_term() | Default.
-spec fetch(kz_json:keys(), Default, kz_json:keys() | atom(), pos_integer()) -> kz_json:json_term() | Default.
...
-spec set(kz_json:keys(), kz_json:json_term()) -> 'ok'.
set(Key, Value) ->
    set(Key, Value, kz_util:to_binary(node()), []).

-spec set_default(kz_json:keys(), kz_json:json_term()) -> 'ok'.
set_default(Key, Value) ->
    set(Key, Value, <<"default">>, []).

-spec set_node(kz_json:keys(), kz_json:json_term()) -> 'ok'.
set_node(Key, Value) ->
    set_node(Key, Value, node()).

-spec set_node(kz_json:keys(), kz_json:json_term(), ne_binary() | atom()) -> 'ok'.
set_node(Key, Value, Node) when is_atom(Node) ->
    set_node(Key, Value, kz_util:to_binary(Node));
set_node(Key, Value, Node) ->
    set(Key, Value, Node, [{'node_specific', 'true'}]).

-spec set(kz_json:keys(), kz_json:json_term(), kz_json:keys(), kz_proplist()) -> 'ok'.

...
-spec multi_set_args(atom(), ne_binary(), kz_proplist(), ne_binary(), binary()) -> binary().
...
-spec multi_unset_args(atom(), ne_binary(), kz_proplist(), ne_binary(), binary()) -> binary().
...
-spec fs_args_to_binary(list(), ne_binary(), binary()) -> binary().

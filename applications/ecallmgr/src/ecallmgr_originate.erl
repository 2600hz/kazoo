...
-spec publish_originate_ready(ne_binary(), pid(), created_uuid() | ne_binary(), kz_json:object(), api_binary(), api_binary()) -> 'ok'.
...
-spec publish_originate_started(api_binary(), ne_binary(), kz_json:object(), ne_binary(), pid()) -> 'ok'.
...
-spec publish_originate_uuid(api_binary(), created_uuid() | ne_binary(), kz_json:object(), ne_binary(), pid()) -> 'ok'.

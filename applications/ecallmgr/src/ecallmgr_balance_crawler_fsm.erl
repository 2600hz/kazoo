...
-type fsm_reply() :: {'next_state', fsm_state(), maybe(pid())} |
                    {'next_state', fsm_state(), maybe(pid()), 'hibernate'}.
...
-spec worker_timeout(fsm_events(), maybe(pid())) -> fsm_reply().

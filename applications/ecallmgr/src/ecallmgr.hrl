...
-record(sip_subscription, {key :: api(binary()) | '_'
                           ,to :: api(binary()) | '$1' | '_'
                           ,from :: api(binary()) | '$2' | '_'
                           ,node :: atom() | '$1' | '_'
...
-record(channel, {uuid :: api(binary()) | '$1' | '_'
                  ,destination :: api(binary()) | '_'
                  ,direction :: api(binary()) | '$1' | '_'
                  ,account_id :: api(binary()) | '$1' | '$2' | '_'
                  ,account_billing :: api(binary()) | '$7' | '_'
                  ,authorizing_id :: api(binary()) | '$1' | '$3' | '_'
                  ,authorizing_type :: api(binary()) | '_'
                  ,owner_id :: api(binary()) | '$1' | '_'
                  ,resource_id :: api(binary()) | '$4' | '_'
                  ,presence_id :: api(binary()) | '$2' | '_'
                  ,fetch_id :: api(binary()) | '$5' | '_'
                  ,bridge_id :: api(binary()) | '$5' | '_'
                  ,reseller_id :: api(binary()) | '_'
                  ,reseller_billing :: api(binary()) | '_'
                  ,realm :: api(binary()) | '_' | '$2'
                  ,username :: api(binary()) | '_' | '$1'
                  ,import_moh = 'false' :: boolean() | '_'
                  ,answered = 'true' :: boolean() | '_'
                  ,other_leg :: api(binary()) | '$2' | '_'
                  ,node :: atom() | '$1' | '$2' | '$3' | '_'
                  ,former_node :: atom() | '$2' | '_'
                  ,timestamp :: gregorian_seconds() | '$3' | '_'
                  ,profile :: api(binary()) | '_'
                  ,context :: api(binary()) | '_'
                  ,dialplan :: api(binary()) | '_'
                  ,precedence = 5 :: pos_integer() | '$2' | '_'
                  ,handling_locally = 'false' :: boolean() | '_' %% is this ecallmgr handling the call control?
                  ,to_tag :: api(binary()) | '_'
                  ,from_tag :: api(binary()) | '_'
                  ,interaction_id :: api(binary()) | '$5' | '_'
                  ,callee_number :: api(binary()) | '$5' | '_'
                  ,callee_name :: api(binary()) | '$5' | '_'
                 }).

-type channel() :: #channel{}.
-type channels() :: [channel()].

-record(conference, {name :: api(binary()) | '$1' | '_'
                     ,uuid :: api(binary()) | '$1' | '_'
                     ,node :: atom() | '$1' | '$2' | '_'
                     ...
                     ,switch_hostname :: api(binary()) | '_'
                     ,switch_url :: api(binary()) | '_'
                     ,switch_external_ip :: api(binary()) | '_'
...
-record(participant, {uuid :: api(binary()) | '$1' | '_'
                      ,node :: atom() | '$2' | '_'
                      ,conference_uuid :: api(binary()) | '$1'| '_'
                      ,conference_name :: api(binary()) | '$1'| '_'

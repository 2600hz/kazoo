...
-record(state, {node :: atom()
                ...
                ,switch_url :: maybe(binary())
                ,switch_uri :: maybe(binary())
...
-spec process_stream(ne_binary(), maybe(binary()), kz_proplist(), atom()) -> any().
...
-spec process_event(ne_binary(), maybe(binary()), kz_proplist(), atom()) -> any().
...
-spec maybe_send_event(ne_binary(), maybe(binary()), kz_proplist(), atom()) -> any().
...
-spec maybe_send_call_event(maybe(binary()), kz_proplist(), atom()) -> any().

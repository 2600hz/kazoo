...
-spec matching_rates(kz_json:objects(), ne_binary()) ->
                            kz_json:objects().
-spec matching_rates(kz_json:objects(), ne_binary(), api(binary()), trunking_options()) ->
                            kz_json:objects().
...
-spec matching_rate(kz_json:object(), ne_binary(), api(binary()), trunking_options()) -> boolean().
matching_rate(Rate, E164, Direction, RouteOptions) ->
...
-spec matching_direction(kz_json:object(), api(binary())) -> boolean().

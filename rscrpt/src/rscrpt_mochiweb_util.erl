%% Borrowed for parsing encoded strings from freeSWITCH
%% Removed all but the pertinent function revdecode and it's
%% dependencies.
...
-module(rscrpt_mochiweb_util).
-author('bob@mochimedia.com').
-export([parse_qs_value/1]).

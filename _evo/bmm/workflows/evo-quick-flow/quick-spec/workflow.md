...
quick_dev_workflow: '{project-root}/_evo/bmm/workflows/evo-quick-flow/quick-dev/workflow.md'
---
...
Read fully and follow: `{project-root}/_evo/bmm/workflows/evo-quick-flow/quick-spec/steps/step-01-understand.md` to begin the workflow.

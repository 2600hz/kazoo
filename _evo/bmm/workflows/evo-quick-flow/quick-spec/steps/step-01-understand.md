...
- **[Y] Continue existing:**
  - Jump directly to the appropriate step based on `stepsCompleted`:
    - `[1]` → Read fully and follow: `{project-root}/_evo/bmm/workflows/evo-quick-flow/quick-spec/steps/step-02-investigate.md` (Step 2)
...
- IF C: Verify `{wipFile}` has `stepsCompleted: [1]`, then read fully and follow: `{project-root}/_evo/bmm/workflows/evo-quick-flow/quick-spec/steps/step-02-investigate.md`

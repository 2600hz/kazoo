...
### 6. Generate Component Strategy Content and Write to File
...
"I've defined the component strategy for {{project_name}} and written it to the document. This balances using proven design system components with custom components for your unique needs.
...
[C] Continue - Move to UX patterns
...
- Read fully and follow: {project-root}/_evo/core/workflows/advanced-elicitation/workflow.md with the current component strategy content
...
- Read fully and follow: {project-root}/_evo/core/workflows/party-mode/workflow.md with the current component strategy
...
- Load `{project-root}/_evo/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-12-ux-patterns.md`
...
Write content to file immediately after generation. Load `{project-root}/_evo/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-12-ux-patterns.md` to define UX consistency patterns.

Remember: Write content to file immediately after generation. Do NOT proceed to step-12 until user explicitly selects 'C' from the menu.

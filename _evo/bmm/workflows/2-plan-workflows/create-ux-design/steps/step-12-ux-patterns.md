...
### 6. Generate UX Patterns Content and Write to File
...
"I've established UX consistency patterns for {{project_name}} and written them to the document. These patterns ensure users have a consistent, predictable experience across all interactions.
...
[C] Continue - Move to responsive design
...
- Read fully and follow: {project-root}/_evo/core/workflows/advanced-elicitation/workflow.md with the current UX patterns content
...
- Read fully and follow: {project-root}/_evo/core/workflows/party-mode/workflow.md with the current UX patterns
...
- Load `{project-root}/_evo/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-13-responsive-accessibility.md`
...
Write content to file immediately after generation. Load `{project-root}/_evo/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-13-responsive-accessibility.md` to define responsive design and accessibility strategy.

Remember: Write content to file immediately after generation. Do NOT proceed to step-13 until user explicitly selects 'C' from the menu.

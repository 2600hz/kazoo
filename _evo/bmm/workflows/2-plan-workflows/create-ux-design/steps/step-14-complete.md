...
**The complete UX design specification is now available at:** `{planning_artifacts}/{active_feature}/ux-design-specification.md`

**Supporting Visual Assets:**

- Color themes visualizer: `{planning_artifacts}/{active_feature}/ux-color-themes.html`
- Design directions mockups: `{planning_artifacts}/{active_feature}/ux-design-directions.html`
...
UX Design complete. Read fully and follow: `{project-root}/_evo/core/tasks/help.md`
...
- ✅ UX Design Specification: `{planning_artifacts}/{active_feature}/ux-design-specification.md`
- ✅ Color Themes Visualizer: `{planning_artifacts}/{active_feature}/ux-color-themes.html`
- ✅ Design Directions: `{planning_artifacts}/{active_feature}/ux-design-directions.html`

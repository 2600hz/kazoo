...
- 📝 WRITE SYNTHESIS CONTENT TO DOCUMENT IMMEDIATELY
...
Content is already written to document when generated. Also replace the `[Research overview and methodology will be appended here]` placeholder in the Research Overview section at the top of the document when C is selected.

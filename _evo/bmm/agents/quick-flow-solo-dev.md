...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="QS or fuzzy match on quick-spec" exec="{project-root}/_evo/bmm/workflows/evo-quick-flow/quick-spec/workflow.md">[QS] Quick Spec: Architect a quick but complete technical spec with implementation-ready stories/specs</item>
    <item cmd="QD or fuzzy match on quick-dev" exec="{project-root}/_evo/bmm/workflows/evo-quick-flow/quick-dev/workflow.md">[QD] Quick-flow Develop: Implement a story tech spec end-to-end (Core of Quick Flow)</item>
    <item cmd="QQ or fuzzy match on evo-quick-dev-new-preview" exec="{project-root}/_evo/bmm/workflows/evo-quick-flow/evo-quick-dev-new-preview/workflow.md">[QQ] Quick Dev New (Preview): Unified quick flow — clarify intent, plan, implement, review, present (experimental)</item>

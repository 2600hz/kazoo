...
-spec is_ipv4(nonempty_string() | ne_binary()) -> boolean().
...
-spec is_ipv6(nonempty_string() | ne_binary()) -> boolean().
...
-spec verify_cidr(string() | ne_binary(), string() | ne_binary()) -> boolean().
...
-spec expand_cidr(string() | ne_binary()) -> [ne_binary(),...] | [].
...
-spec is_rfc1918_ip(string() | ne_binary()) -> boolean().
is_rfc1918_ip(IP) ->
...
-spec iptuple_to_binary({1..255, 1..255, 1..255, 1..255}) -> ne_binary().
iptuple_to_binary({A,B,C,D}) ->

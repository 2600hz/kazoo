...
card_test() ->
    ...
    ?assertEqual(true, wh_json_validator:is_valid_object(CardJObj, CardSchema)).
...
address_test() ->
    ...
    ?assertEqual(true, wh_json_validator:is_valid_object(AddressJObj, AddressSchema)).
...
geo_test() ->
    ...
    ?assertEqual(true, wh_json_validator:is_valid_object(GeoJObj, GeoSchema)).

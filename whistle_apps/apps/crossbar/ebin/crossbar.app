{application,crossbar,
             [{description,"Crossbar - REST Interface to the stars"},
              ...
              {modules,[cb_accounts,cb_api_auth,cb_callflows,cb_cdr,
                        ...
                        cb_servers,cb_signup,cb_simple_authz,cb_skels,
                        cb_token_auth,cb_ts_accounts,cb_ts_users,cb_user_auth,
                        cb_users,cb_vmboxes,crossbar,crossbar_app,
                        crossbar_bindings,crossbar_doc,crossbar_filter,

...
%% @end
%%--------------------------------------------------------------------
handle_info({binding_fired, Pid, <<"v1_resource.allowed_methods.connectivity">>, Payload}, State) ->
    spawn(fun() ->
...
handle_info({binding_fired, Pid, <<"v1_resource.resource_exists.connectivity">>, Payload}, State) ->
    spawn(fun() ->
...
handle_info({binding_fired, Pid, <<"v1_resource.validate.connectivity">>, [RD, Context | Params]}, State) ->
    spawn(fun() ->
...
handle_info({binding_fired, Pid, <<"v1_resource.execute.post.connectivity">>, [RD, Context | Params]}, State) ->
    spawn(fun() ->
                  _ = crossbar_util:put_reqid(Context),
...
handle_info({binding_fired, Pid, <<"v1_resource.execute.put.connectivity">>, [RD, Context | Params]}, State) ->
    spawn(fun() ->
                  _ = crossbar_util:put_reqid(Context),
                  Context1 = crossbar_doc:save(Context),
                  Pid ! {binding_result, true, [RD, Context1, Params]}
...
handle_info({binding_fired, Pid, <<"v1_resource.execute.delete.connectivity">>, [RD, Context | Params]}, State) ->
    spawn(fun() ->
                  _ = crossbar_util:put_reqid(Context),
...
bind_to_crossbar() ->
    _ = crossbar_bindings:bind(<<"v1_resource.allowed_methods.connectivity">>),
    _ = crossbar_bindings:bind(<<"v1_resource.resource_exists.connectivity">>),
    _ = crossbar_bindings:bind(<<"v1_resource.validate.connectivity">>),
    crossbar_bindings:bind(<<"v1_resource.execute.#.connectivity">>).

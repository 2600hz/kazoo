...
-spec maybe_skip_reauth/3 :: (ne_binary(), #limits{}, wh_json:json_object()) -> 'ok'.
...
-spec send_allow_resp/1 :: (wh_json:json_object()) -> 'ok'.
-spec send_allow_resp/2 :: (wh_json:json_object(), wh_json:json_object()) -> 'ok'.
...
-spec send_deny_resp/1 :: (wh_json:json_object()) -> 'ok'.
-spec send_deny_resp/2 :: (wh_json:json_object(), wh_json:json_object()) -> 'ok'.

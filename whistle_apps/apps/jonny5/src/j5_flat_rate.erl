...
-spec maybe_consume_flat_rate/2 :: (#limits{}, wh_json:json_object()) -> boolean().
...
-spec consume_inbound_limits/2 :: (#limits{}, integer()) -> integer().
...
-spec consume_twoway_limits/2 :: (#limits{}, integer()) -> integer().

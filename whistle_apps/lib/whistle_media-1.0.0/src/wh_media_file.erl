...
-spec get_uri/2 :: (ne_binaries() | ne_binary(), wh_json:object()) ->
                           {'ok', ne_binary()} |
                           {'error', 'not_found'} |
                           {'error', 'no_data'} |
...
-spec prepare_proxy/1 :: (ne_binaries()) -> 'ok' | 'error'.
...
-spec find_attachment/1 :: (ne_binaries() | ne_binary()) ->
...
-spec maybe_find_attachment/2 :: (ne_binary(), ne_binary()) ->
                                         {'ok', {ne_binary(), ne_binary(), ne_binary()}} |
                                         {'error', 'not_found'}.
-spec maybe_find_attachment/3 :: (wh_json:object(), ne_binary(), ne_binary()) ->
                                         {'ok', {ne_binary(), ne_binary(), ne_binary()}} |
                                         {'error', 'not_found'} |
                                         {'error', 'no_data'}.
...
-spec maybe_local_haproxy_uri/4 :: (wh_json:object(), ne_binary(), ne_binary(), ne_binary()) ->
                                           {'ok', ne_binary()} |
                                           {'error', 'no_stream_strategy'}.
maybe_local_haproxy_uri(JObj, Db, Id, Attachment) ->
...
-spec maybe_media_manager_proxy_uri/4 :: (wh_json:object(), ne_binary(), ne_binary(), ne_binary()) ->
                                                 {'ok', ne_binary()} |
                                                 {'error', 'no_stream_strategy'}.

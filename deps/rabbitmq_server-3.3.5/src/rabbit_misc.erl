...
-spec(queue_fold/3 :: (fun ((any(), B) -> B), B,queues:queue()) -> B).
...
-spec(gb_trees_cons/3 :: (any(), any(), gb_trees:gb_tree()) -> gb_trees:gb_tree()).
-spec(gb_trees_fold/3 :: (fun ((any(), any(), A) -> A), A, gb_trees:gb_tree()) -> A).
-spec(gb_trees_foreach/2 ::
        (fun ((any(), any()) -> any()), gb_trees:gb_tree()) -> 'ok').
...
-spec(gb_sets_difference/2 :: (gb_sets:gb_set(), gb_sets:gb_set()) -> gb_sets:gb_set()).

...
-type(state() :: #vqstate {
             ...
             q4                    :: ?QUEUE:?QUEUE(),
             next_seq_id           :: seq_id(),
             ram_pending_ack       :: gb_trees:gb_tree(),
             disk_pending_ack      :: gb_trees:gb_tree(),
             index_state           :: any(),
             ...
             rates                 :: rates(),
             msgs_on_disk          :: gb_sets:gb_set(),
             msg_indices_on_disk   :: gb_sets:gb_set(),
             unconfirmed           :: gb_sets:gb_set(),
             confirmed             :: gb_sets:gb_set(),
